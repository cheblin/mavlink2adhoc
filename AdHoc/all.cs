...
namespace org.mavlink {
    ...
    /**
        ...
        <see cref = 'ADAP_TUNING' id = '11010'/>
        <see cref = 'ADSB_VEHICLE' id = '246'/>
        <see cref = 'AHRS' id = '163'/>
        <see cref = 'AHRS2' id = '178'/>
        <see cref = 'AHRS3' id = '182'/>
        <see cref = 'AIRLINK_AUTH' id = '52000'/>
        <see cref = 'AIRLINK_AUTH_RESPONSE' id = '52001'/>
        <see cref = 'AIRSPEED' id = '295'/>
        <see cref = 'AIRSPEED_AUTOCAL' id = '174'/>
        <see cref = 'AIS_VESSEL' id = '301'/>
        <see cref = 'ALTITUDE' id = '141'/>
        <see cref = 'AOA_SSA' id = '11020'/>
        <see cref = 'AP_ADC' id = '153'/>
        <see cref = 'ARRAY_TEST_0' id = '17150'/>
        <see cref = 'ARRAY_TEST_1' id = '17151'/>
        <see cref = 'ARRAY_TEST_3' id = '17153'/>
        <see cref = 'ARRAY_TEST_4' id = '17154'/>
        <see cref = 'ARRAY_TEST_5' id = '17155'/>
        <see cref = 'ARRAY_TEST_6' id = '17156'/>
        <see cref = 'ARRAY_TEST_7' id = '17157'/>
        <see cref = 'ARRAY_TEST_8' id = '17158'/>
        ...
        <see cref = 'AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_EXT' id = '60000'/>
        <see cref = 'AUTOPILOT_VERSION' id = '148'/>
        <see cref = 'AUTOPILOT_VERSION_REQUEST' id = '183'/>
        ...
        <see cref = 'COMPASSMOT_STATUS' id = '177'/>
        ...
        <see cref = 'CONTROL_STATUS' id = '512'/>
        <see cref = 'CONTROL_SYSTEM_STATE' id = '146'/>
        <see cref = 'CUBEPILOT_FIRMWARE_UPDATE_RESP' id = '50005'/>
        <see cref = 'CUBEPILOT_FIRMWARE_UPDATE_START' id = '50004'/>
        <see cref = 'CUBEPILOT_RAW_RC' id = '50001'/>
        <see cref = 'CURRENT_EVENT_SEQUENCE' id = '411'/>
        <see cref = 'CURRENT_MODE' id = '436'/>
        <see cref = 'DATA16' id = '169'/>
        <see cref = 'DATA32' id = '170'/>
        <see cref = 'DATA64' id = '171'/>
        <see cref = 'DATA96' id = '172'/>
        ...
        <see cref = 'DEEPSTALL' id = '195'/>
        <see cref = 'DEVICE_OP_READ' id = '11000'/>
        <see cref = 'DEVICE_OP_READ_REPLY' id = '11001'/>
        <see cref = 'DEVICE_OP_WRITE' id = '11002'/>
        <see cref = 'DEVICE_OP_WRITE_REPLY' id = '11003'/>
        <see cref = 'DIGICAM_CONFIGURE' id = '154'/>
        <see cref = 'DIGICAM_CONTROL' id = '155'/>
        <see cref = 'DISTANCE_SENSOR' id = '132'/>
        <see cref = 'EFI_STATUS' id = '225'/>
        <see cref = 'EKF_EXT' id = '8007'/>
        <see cref = 'EKF_STATUS_REPORT' id = '193'/>
        <see cref = 'ENCAPSULATED_DATA' id = '131'/>
        <see cref = 'ESC_EEPROM' id = '292'/>
        <see cref = 'ESC_INFO' id = '290'/>
        <see cref = 'ESC_STATUS' id = '291'/>
        <see cref = 'ESC_TELEMETRY_13_TO_16' id = '11040'/>
        <see cref = 'ESC_TELEMETRY_17_TO_20' id = '11041'/>
        <see cref = 'ESC_TELEMETRY_1_TO_4' id = '11030'/>
        <see cref = 'ESC_TELEMETRY_21_TO_24' id = '11042'/>
        <see cref = 'ESC_TELEMETRY_25_TO_28' id = '11043'/>
        <see cref = 'ESC_TELEMETRY_29_TO_32' id = '11044'/>
        <see cref = 'ESC_TELEMETRY_5_TO_8' id = '11031'/>
        <see cref = 'ESC_TELEMETRY_9_TO_12' id = '11032'/>
        <see cref = 'ESTIMATOR_SENSOR_FUSION_STATUS' id = '514'/>
        ...
        <see cref = 'FENCE_FETCH_POINT' id = '161'/>
        <see cref = 'FENCE_POINT' id = '160'/>
        ...
        <see cref = 'GIMBAL_REPORT' id = '200'/>
        <see cref = 'GIMBAL_TORQUE_CMD_REPORT' id = '214'/>
        ...
        <see cref = 'GNSS_INTEGRITY' id = '441'/>
        <see cref = 'GOPRO_GET_REQUEST' id = '216'/>
        <see cref = 'GOPRO_GET_RESPONSE' id = '217'/>
        <see cref = 'GOPRO_HEARTBEAT' id = '215'/>
        <see cref = 'GOPRO_SET_REQUEST' id = '218'/>
        <see cref = 'GOPRO_SET_RESPONSE' id = '219'/>
        ...
        <see cref = 'GROUP_END' id = '415'/>
        <see cref = 'GROUP_START' id = '414'/>
        <see cref = 'GSM_LINK_STATUS' id = '8014'/>
        <see cref = 'HEARTBEAT' id = '0'/>
        <see cref = 'HERELINK_TELEM' id = '50003'/>
        <see cref = 'HERELINK_VIDEO_STREAM_INFORMATION' id = '50002'/>
        ...
        <see cref = 'MLRS_RADIO_LINK_FLOW_CONTROL' id = '60047'/>
        <see cref = 'MLRS_RADIO_LINK_INFORMATION' id = '60046'/>
        <see cref = 'MLRS_RADIO_LINK_STATS' id = '60045'/>
        <see cref = 'MOTION_CUE_EXTRA' id = '52504'/>
        <see cref = 'MOTION_PLATFORM_STATE' id = '52502'/>
        <see cref = 'MOUNT_CONFIGURE' id = '156'/>
        <see cref = 'MOUNT_CONTROL' id = '157'/>
        <see cref = 'MOUNT_ORIENTATION' id = '265'/>
        <see cref = 'MOUNT_STATUS' id = '158'/>
        <see cref = 'NAMED_VALUE_FLOAT' id = '251'/>
        <see cref = 'NAMED_VALUE_INT' id = '252'/>
        <see cref = 'NAMED_VALUE_STRING' id = '11060'/>
        <see cref = 'NAV_CONTROLLER_OUTPUT' id = '62'/>
        <see cref = 'NAV_FILTER_BIAS' id = '220'/>
        <see cref = 'OBSTACLE_DISTANCE' id = '330'/>
        <see cref = 'OBSTACLE_DISTANCE_3D' id = '11037'/>
        ...
        <see cref = 'OSD_PARAM_CONFIG' id = '11033'/>
        <see cref = 'OSD_PARAM_CONFIG_REPLY' id = '11034'/>
        <see cref = 'OSD_PARAM_SHOW_CONFIG' id = '11035'/>
        <see cref = 'OSD_PARAM_SHOW_CONFIG_REPLY' id = '11036'/>
        ...
        <see cref = 'PARAM_VALUE_ARRAY' id = '60041'/>
        <see cref = 'PID_TUNING' id = '194'/>
        <see cref = 'PING' id = '4'/>
        ...
        <see cref = 'QSHOT_STATUS' id = '60020'/>
        <see cref = 'RADIO' id = '166'/>
        <see cref = 'RADIO_CALIBRATION' id = '221'/>
        <see cref = 'RADIO_RC_CHANNELS' id = '420'/>
        <see cref = 'RADIO_STATUS' id = '109'/>
        <see cref = 'RALLY_FETCH_POINT' id = '176'/>
        <see cref = 'RALLY_POINT' id = '175'/>
        <see cref = 'RANGEFINDER' id = '173'/>
        <see cref = 'RANGING_BEACON' id = '513'/>
        ...
        <see cref = 'RC_CHANNELS_OVERRIDE_V2' id = '421'/>
        <see cref = 'RC_CHANNELS_RAW' id = '35'/>
        <see cref = 'RC_CHANNELS_SCALED' id = '34'/>
        <see cref = 'RELAY_STATUS' id = '376'/>
        <see cref = 'REMOTE_LOG_BLOCK_STATUS' id = '185'/>
        <see cref = 'REMOTE_LOG_DATA_BLOCK' id = '184'/>
        ...
        <see cref = 'SECURE_COMMAND' id = '11004'/>
        <see cref = 'SECURE_COMMAND_REPLY' id = '11005'/>
        <see cref = 'SENSORPOD_STATUS' id = '8012'/>
        <see cref = 'SENSOR_AIRFLOW_ANGLES' id = '8016'/>
        <see cref = 'SENSOR_OFFSETS' id = '150'/>
        ...
        <see cref = 'SET_MAG_OFFSETS' id = '151'/>
        <see cref = 'SET_MODE' id = '11'/>
        <see cref = 'SET_POSITION_TARGET_GLOBAL_INT' id = '86'/>
        <see cref = 'SET_POSITION_TARGET_LOCAL_NED' id = '84'/>
        <see cref = 'SET_VELOCITY_LIMITS' id = '354'/>
        <see cref = 'SIMSTATE' id = '164'/>
        <see cref = 'SIM_STATE' id = '108'/>
        <see cref = 'SMART_BATTERY_INFO' id = '370'/>
        <see cref = 'STATUSTEXT' id = '253'/>
        <see cref = 'STORAGE_INFORMATION' id = '261'/>
        <see cref = 'STORM32_GIMBAL_MANAGER_CONTROL' id = '60012'/>
        <see cref = 'STORM32_GIMBAL_MANAGER_CONTROL_PITCHYAW' id = '60013'/>
        <see cref = 'STORM32_GIMBAL_MANAGER_CORRECT_ROLL' id = '60014'/>
        <see cref = 'STORM32_GIMBAL_MANAGER_INFORMATION' id = '60010'/>
        <see cref = 'STORM32_GIMBAL_MANAGER_STATUS' id = '60011'/>
        <see cref = 'SUPPORTED_TUNES' id = '401'/>
        <see cref = 'SYSTEM_TIME' id = '2'/>
        <see cref = 'SYS_STATUS' id = '1'/>
        <see cref = 'TARGET_ABSOLUTE' id = '510'/>
        <see cref = 'TARGET_RELATIVE' id = '511'/>
        ...
        <see cref = 'UALBERTA_SYS_STATUS' id = '222'/>
        <see cref = 'UAVCAN_NODE_INFO' id = '311'/>
        <see cref = 'UAVCAN_NODE_STATUS' id = '310'/>
        <see cref = 'UAVIONIX_ADSB_GET' id = '10006'/>
        <see cref = 'UAVIONIX_ADSB_OUT_CFG' id = '10001'/>
        <see cref = 'UAVIONIX_ADSB_OUT_CFG_FLIGHTID' id = '10005'/>
        <see cref = 'UAVIONIX_ADSB_OUT_CFG_REGISTRATION' id = '10004'/>
        <see cref = 'UAVIONIX_ADSB_OUT_CONTROL' id = '10007'/>
        <see cref = 'UAVIONIX_ADSB_OUT_DYNAMIC' id = '10002'/>
        <see cref = 'UAVIONIX_ADSB_OUT_STATUS' id = '10008'/>
        <see cref = 'UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT' id = '10003'/>
        <see cref = 'UTM_GLOBAL_POSITION' id = '340'/>
        <see cref = 'V2_EXTENSION' id = '248'/>
        <see cref = 'VELOCITY_LIMITS' id = '355'/>
...
*/
[Flags]
enum UAVIONIX_ADSB_OUT_CONTROL_STATE{
...
*/
[Flags]
enum UAVIONIX_ADSB_OUT_STATUS_STATE{
...
State flags for ADS-B transponder status report
*/
enum UAVIONIX_ADSB_OUT_STATUS_NIC_NACP{
...
*/
class UAVIONIX_ADSB_OUT_CFG_REGISTRATION{

/**
Aircraft Registration (ASCII string A-Z, 0-9 only), e.g. "N8644B ". Trailing spaces (0x20) only. This
is null-terminated.
*/
[D(+9)] string  registration;
...
*/
class UAVIONIX_ADSB_OUT_CFG_FLIGHTID{

/**
Flight Identification: 8 ASCII characters, '0' through '9', 'A' through 'Z' or space. Spaces (0x20) used
as a trailing pad character, or when call sign is unavailable. Reflects Control message setting. This
is null-terminated.
*/
[D(+9)] string  flight_id;
...
*/
class UAVIONIX_ADSB_OUT_CONTROL{

/**
ADS-B transponder control state flags
*/
UAVIONIX_ADSB_OUT_CONTROL_STATE state;
...
/**
Flight Identification: 8 ASCII characters, '0' through '9', 'A' through 'Z' or space. Spaces (0x20) used
as a trailing pad character, or when call sign is unavailable.
*/
[D(+8)] string  flight_id;

/**
X-Bit enable (military transponders only)
*/
UAVIONIX_ADSB_XBIT x_bit;
...
*/
class UAVIONIX_ADSB_OUT_STATUS{

/**
ADS-B transponder status state flags
*/
UAVIONIX_ADSB_OUT_STATUS_STATE state;
...
/**
Integrity and Accuracy of traffic reported as a 4-bit value for each field (NACp 7:4, NIC 3:0) and encoded
by Containment Radius (HPL) and Estimated Position Uncertainty (HFOM), respectively
*/
UAVIONIX_ADSB_OUT_STATUS_NIC_NACP NIC_NACp;
...
*/
UAVIONIX_ADSB_OUT_STATUS_FAULT fault;
...
*/
class HERELINK_VIDEO_STREAM_INFORMATION{
...
*/
class CUBEPILOT_FIRMWARE_UPDATE_START{
...
*/
class CUBEPILOT_FIRMWARE_UPDATE_RESP{
...
enum SECURE_COMMAND_OP{

/**
Get an 8 byte session key which is used for remote secure updates which operate on flight controller data
such as bootloader public keys. Return data will be 8 bytes on success. The session key remains valid
until either the flight controller reboots or another SECURE_COMMAND_GET_SESSION_KEY is run.
*/
SECURE_COMMAND_GET_SESSION_KEY = 0, 

/**
Get an 8 byte session key which is used for remote secure updates which operate on RemoteID module data.
Return data will be 8 bytes on success. The session key remains valid until either the remote ID module
reboots or another SECURE_COMMAND_GET_REMOTEID_SESSION_KEY is run.
*/
SECURE_COMMAND_GET_REMOTEID_SESSION_KEY = 1, 

/**
Remove range of public keys from the bootloader. Command data consists of two bytes, first byte if index
of first public key to remove. Second byte is the number of keys to remove. If all keys are removed then
secure boot is disabled and insecure firmware can be loaded.
*/
SECURE_COMMAND_REMOVE_PUBLIC_KEYS = 2, 

/**
Get current public keys from the bootloader. Command data consists of two bytes, first byte is index of
first public key to fetch, 2nd byte is number of keys to fetch. Total data needs to fit in data portion
of reply (max 6 keys for 32 byte keys). Reply data has the index of the first key in the first byte,
followed by the keys. Returned keys may be less than the number of keys requested if there are less keys
installed than requested.
*/
SECURE_COMMAND_GET_PUBLIC_KEYS = 3, 

/**
Set current public keys in the bootloader. Data consists of a one byte public key index followed by the
public keys. With 32 byte keys this allows for up to 6 keys to be set in one request. Keys outside of
the range that is being set will remain unchanged.
*/
SECURE_COMMAND_SET_PUBLIC_KEYS = 4, 

/**
Get config data for remote ID module. This command should be sent to the component ID of the flight controller
which will forward it to the RemoteID module either over mavlink or DroneCAN. Data format is specific
to the RemoteID implementation, see RemoteID firmware documentation for details.
*/
SECURE_COMMAND_GET_REMOTEID_CONFIG = 5, 

/**
Set config data for remote ID module. This command should be sent to the component ID of the flight controller
which will forward it to the RemoteID module either over mavlink or DroneCAN. Data format is specific
to the RemoteID implementation, see RemoteID firmware documentation for details.
*/
...
/**
Flash bootloader from local storage. Data is the filename to use for the bootloader. This is intended
to be used with MAVFtp to upload a new bootloader to a microSD before flashing.
*/
...
/**
2 bit value representing altitude frame. 0: absolute, 1: relative home, 2: relative origin, 3: relative
terrain
*/
ALT_FRAME = 24, 
...
move back to active mode when it receives a new rate command.
*/
...
Feedback flags.
*/
CAMERA_FEEDBACK_FLAGS flags;

/**
Completed image captures.
*/
 ushort  completed_captures;
...
*/
class AUTOPILOT_VERSION_REQUEST{
...
*/
MAV_REMOTE_LOG_DATA_BLOCK_COMMANDS seqno;
...
*/
MAV_REMOTE_LOG_DATA_BLOCK_STATUSES status;
...
*/
class GIMBAL_TORQUE_CMD_REPORT{
...
*/
class GOPRO_HEARTBEAT{

/**
Status.
*/
GOPRO_HEARTBEAT_STATUS status;
...
/**
Send a secure command. Data should be signed with a private key corresponding with a public key known
to the recipient. Signature should be over the concatenation of the sequence number (little-endian format),
the operation (little-endian format) the data and the session key. For SECURE_COMMAND_GET_SESSION_KEY
the session key should be zero length. The data array consists of the data followed by the signature.
The sum of the data_length and the sig_length cannot be more than 220. The format of the data is command
specific.
*/
class SECURE_COMMAND{
...
*/
 ulong  time_delta_usec;

/**
Defines a rotation vector [roll, pitch, yaw] to the current MAV_FRAME_BODY_FRD from the previous MAV_FRAME_BODY_FRD.
*/
[D(3)]  float [] angle_delta;

/**
Change in position to the current MAV_FRAME_BODY_FRD from the previous FRAME_BODY_FRD rotated to the current
MAV_FRAME_BODY_FRD.
*/
...
*/
class ESC_TELEMETRY_1_TO_4{

/**
Temperature.
*/
[D(4)]  byte [] temperature;
...
Config type.
*/
OSD_PARAM_CONFIG_TYPE config_type;
...
*/
class OSD_PARAM_SHOW_CONFIG_REPLY{
...
/**
Unique ID given to each obstacle so that its movement can be tracked. Use UINT16_MAX if object ID is unknown
...
/**
The MCU status, giving MCU temperature and voltage. The min and max voltages are to allow for detecting
...
MCU voltage minimum
*/
 ushort  MCU_voltage_min;

/**
MCU voltage maximum
*/
 ushort  MCU_voltage_max;
...
/**
Send a key-value pair as string. The use of this message is discouraged for normal packets, but a quite
efficient way for testing new messages and getting experimental debug output.
*/
class NAMED_VALUE_STRING{
...
*/
[Flags]
enum MAV_BATTERY_STATUS_FLAGS:long{
...
Battery is cell balancing (during charging).
          Not ready to use (MAV_BATTERY_STATUS_FLAGS_NOT_READY_TO_USE
may be set).
*/
...
/**
It is likely to be set for most faults, and may also be set according to a maintenance schedule (such
as age, or number of recharge cycles, etc.).
...
/**
If a fault is triggered then and protections are enabled then a safety fault (MAV_BATTERY_STATUS_FLAGS_FAULT_PROTECTION_SYSTEM)
will be set and power from the battery will be stopped.
          Note that battery protection monitoring
should only be enabled when the vehicle is landed. Once the vehicle is armed, or starts moving, the protections
should be disabled to prevent false positives from disabling the output.
*/
MAV_BATTERY_STATUS_FLAGS_PROTECTIONS_ENABLED = 128, 

/**
Other faults like MAV_BATTERY_STATUS_FLAGS_FAULT_OVER_VOLT may also be set, indicating the cause of the
protection fault.
...
One or more cells are below their minimum voltage rating.
          A battery that had deep-discharged
might be irrepairably damaged, and set both MAV_BATTERY_STATUS_FLAGS_FAULT_UNDER_VOLT and MAV_BATTERY_STATUS_FLAGS_BAD_BATTERY.
*/
...
/**
If unset the capacity_consumed indicates the consumption since vehicle power-on, as measured using a power
monitor. The capacity_remaining, if provided, indicates the estimated remaining capacity on the assumption
that the battery was full on vehicle boot.
          If unset a GCS is recommended to advise that users
fully charge the battery on power on.
*/
MAV_BATTERY_STATUS_FLAGS_CAPACITY_RELATIVE_TO_FULL = 262144, 

/**
Reserved (not used). If set, this will indicate that an additional status field exists for higher status
values.
*/
...
*/
[Flags]
enum GCS_CONTROL_STATUS_FLAGS{

/**
Note that to request control of the system a GCS should send MAV_CMD_REQUEST_OPERATOR_CONTROL to the component
emitting CONTROL_STATUS with this flag set.
*/
GCS_CONTROL_STATUS_FLAGS_SYSTEM_MANAGER = 1, 

/**
Takeover allowed (requests for control will be granted). If not set requests for control will be rejected,
but the controlling GCS will be notified (and may release control or allow takeover).
*/
...
*/
[Flags]
enum TARGET_ABSOLUTE_SENSOR_CAPABILITY_FLAGS{
...
*/
[Flags]
enum RADIO_RC_CHANNELS_FLAGS{

/**
Failsafe is active. The content of the RC channels data in the RADIO_RC_CHANNELS message is implementation
dependent.
*/
RADIO_RC_CHANNELS_FLAGS_FAILSAFE = 1, 

/**
Channel data may be out of date. This is set when the receiver is unable to validate incoming data from
the transmitter and has therefore resent the last valid data it received.
*/
...
*/
GPS_JAMMING_STATE_NOT_JAMMED = 1, 
...
*/
GPS_SPOOFING_STATE_NOT_SPOOFED = 1, 
...
*/
ESC_FIRMWARE_BLUEJAY = 2, 

/**
BLHeli32 ESC firmware.
*/
ESC_FIRMWARE_BLHELI32 = 3, 
...
*/
[Flags]
enum RANGING_BEACON_ALT_TYPE{

/**
Altitude above WGS84 ellipsoid.
*/
RANGING_BEACON_ALT_TYPE_WGS84 = 0, 

/**
Altitude above Mean Sea Level (AMSL).
*/
RANGING_BEACON_ALT_TYPE_MSL = 1, 
...
*/
enum ESTIMATOR_SENSOR_FUSION_SOURCE{

/**
GNSS
*/
ESTIMATOR_SENSOR_FUSION_SOURCE_GPS = 0, 

/**
Optical Flow
*/
ESTIMATOR_SENSOR_FUSION_SOURCE_OF = 1, 

/**
External Vision
*/
ESTIMATOR_SENSOR_FUSION_SOURCE_EV = 2, 

/**
Auxiliary Global Position
*/
ESTIMATOR_SENSOR_FUSION_SOURCE_AGP = 3, 

/**
Barometer
*/
ESTIMATOR_SENSOR_FUSION_SOURCE_BARO = 4, 

/**
Range Finder
*/
ESTIMATOR_SENSOR_FUSION_SOURCE_RNG = 5, 

/**
Magnetometer
*/
ESTIMATOR_SENSOR_FUSION_SOURCE_MAG = 6, 

/**
Airspeed
*/
ESTIMATOR_SENSOR_FUSION_SOURCE_ASPD = 7, 

/**
Ranging Beacon
*/
ESTIMATOR_SENSOR_FUSION_SOURCE_RANGING_BEACON = 8, 
...
/**
Power monitors would not set this bit, indicating that capacity_consumed is relative to drone power-on,
and that other values are estimated based on the assumption that the battery was full on power-on.
 
    
*/
class BATTERY_STATUS_V2{
...
/**
Battery current (through all cells/loads). Positive value when discharging and negative if charging. NaN:
field not provided.
*/
 float  current;

/**
Consumed charge. NaN: field not provided. This is either the consumption since power-on or since the battery
was full, depending on the value of MAV_BATTERY_STATUS_FLAGS_CAPACITY_RELATIVE_TO_FULL.
*/
 float  capacity_consumed;

/**
Remaining charge (until empty). NaN: field not provided. Note: If MAV_BATTERY_STATUS_FLAGS_CAPACITY_RELATIVE_TO_FULL
is unset, this value is based on the assumption the battery was full when the system was powered.
*/
...
*/
MAV_BATTERY_STATUS_FLAGS status_flags;
...
/**
For instance, the channels data could contain failsafe values configured in the receiver; the default
is to carry the last valid data.
        Note: The RC channels fields are extensions to ensure that they
are located at the end of the serialized payload and subject to MAVLink's trailing-zero trimming.
*/
class RADIO_RC_CHANNELS{
...
*/
 uint  time_last_update_ms;

/**
Radio RC channels status flags.
*/
RADIO_RC_CHANNELS_FLAGS flags;

/**
Total number of RC channels being received. This can be larger than 32, indicating that more channels
are available but not given in this message.
*/
 byte  count;

/**
Channels with indexes equal or above count should be set to 0, to benefit from MAVLink's trailing-zero
trimming.
*/
[D(32)]  short [] channels;
...
/**
Information about key components of GNSS receivers, like signal authentication, interference and system
errors.
*/
class GNSS_INTEGRITY{
...
*/
GPS_SYSTEM_ERROR_FLAGS system_errors;

/**
Signal authentication state of the GPS system.
*/
GPS_AUTHENTICATION_STATE authentication_state;

/**
Signal jamming state of the GPS system.
*/
GPS_JAMMING_STATE jamming_state;

/**
Signal spoofing state of the GPS system.
*/
GPS_SPOOFING_STATE spoofing_state;

/**
The state of the RAIM processing.
*/
GPS_RAIM_STATE raim_state;
...
*/
TARGET_ABSOLUTE_SENSOR_CAPABILITY_FLAGS sensor_capabilities;
...
/**
Quaternion of the target's orientation from the target's frame to the TARGET_OBS_FRAME (w, x, y, z order,
zero-rotation is 1, 0, 0, 0)
*/
[D(4)]  float [] q_target;

/**
Quaternion of the sensor's orientation from TARGET_OBS_FRAME to vehicle-carried NED. (Ignored if set to
(0,0,0,0)) (w, x, y, z order, zero-rotation is 1, 0, 0, 0)
*/
[D(4)]  float [] q_sensor;
...
/**
Control status. For example, whether takeover of the `gcs_main` role is allowed, and whether this CONTROL_STATUS
instance defines the default controlling GCS for the whole system.
*/
GCS_CONTROL_STATUS_FLAGS flags;
...
/**
System IDs from which the system can recieve state-changing commands/messages in multi-control mode. All
values should be zero for single-ower mode.
*/
[D(10)]  byte [] gcs_secondary;
...
ESC firmware type.
*/
ESC_FIRMWARE firmware;

/**
Zero-indexed sequence number of this message when multiple messages are required to transfer the complete
EEPROM data. The first message has index 0. For single-message transfers, set to 0.
*/
 byte  msg_index;

/**
Total number of messages required to transfer the complete EEPROM data. For single-message transfers,
set to 1. Receivers should collect all messages from index 0 to msg_count-1 before reconstructing the
complete data.
*/
 byte  msg_count;
...
/**
, etc.). Set bits indicate bytes to write, cleared bits indicate bytes to skip. This allows precise updates
of individual parameters without overwriting the entire EEPROM.
*/
[D(6)]  uint [] write_mask;
...
Range information from a radio beacon for trilateration-based positioning.
        This message is telemetry
intended for consumption by an autopilot (MAVLink does not define the mechanism used to determine the
range).
**WIP**
*/
class RANGING_BEACON{
...
*/
RANGING_BEACON_ALT_TYPE alt_type;
...
*/
RANGING_BEACON_STATUS_FLAG status;

}

/**
Status of estimator sensor fusion sources. Each array is indexed by ESTIMATOR_SENSOR_FUSION_SOURCE - 1.
Each element is a per-instance bitmask (bit 0 = instance 0, etc.). For single-instance sources only bit
0 is used. For multi-instance sources like AGP, multiple bits may be set.
*/
class ESTIMATOR_SENSOR_FUSION_STATUS{

/**
Per-source instance bitmask of sensors the estimator intends to fuse (reflects CTRL params with runtime
overrides via MAV_CMD_ESTIMATOR_SENSOR_ENABLE).
*/
[D(9)]  byte [] intended;
...
*/
[Flags]
enum MAV_STORM32_GIMBAL_MANAGER_CAP_FLAGS{
...
/**
Flags for gimbal manager operation. Used for setting and reporting, unless specified otherwise. If a setting
has been accepted by the gimbal manager is reported in the STORM32_GIMBAL_MANAGER_STATUS message.
*/
[Flags]
enum MAV_STORM32_GIMBAL_MANAGER_FLAGS{

/**
Request to set RC input to active, or report RC input is active. Implies RC mixed. RC exclusive is achieved
...
/**
Both antenna 1 and antenna 2 transmit flags can be set simultaneously, e.g., in case of dual-band or dual-frequency
systems.
        If neither flag is set then antenna 1 should be assumed.
*/
[Flags]
enum MLRS_RADIO_LINK_STATS_FLAGS{

/**
Rssi values are in negative dBm. Values 1..254 corresponds to -1..-254 dBm. 0: no reception, UINT8_MAX:
unknown.
*/
MLRS_RADIO_LINK_STATS_FLAGS_RSSI_DBM = 0x0001, 

/**
Rx receive antenna. When set the data received on antenna 2 are taken, else the data stems from antenna
1.
*/
MLRS_RADIO_LINK_STATS_FLAGS_RX_RECEIVE_ANTENNA2 = 0x0002, 

/**
Rx transmit antenna. Data are transmitted on antenna 1.
*/
MLRS_RADIO_LINK_STATS_FLAGS_RX_TRANSMIT_ANTENNA1 = 0x0004, 

/**
Rx transmit antenna. Data are transmitted on antenna 2.
*/
MLRS_RADIO_LINK_STATS_FLAGS_RX_TRANSMIT_ANTENNA2 = 0x0008, 

/**
Tx receive antenna. When set the data received on antenna 2 are taken, else the data stems from antenna
1.
*/
MLRS_RADIO_LINK_STATS_FLAGS_TX_RECEIVE_ANTENNA2 = 0x0010, 

/**
Tx transmit antenna. Data are transmitted on antenna 1.
*/
MLRS_RADIO_LINK_STATS_FLAGS_TX_TRANSMIT_ANTENNA1 = 0x0020, 

/**
Tx transmit antenna. Data are transmitted on antenna 2.
*/
MLRS_RADIO_LINK_STATS_FLAGS_TX_TRANSMIT_ANTENNA2 = 0x0040, 
...
/**
Information about a gimbal manager. This message should be requested by a ground station using MAV_CMD_REQUEST_MESSAGE.
It mirrors some fields of the GIMBAL_DEVICE_INFORMATION message, but not all. If the additional information
is desired, also GIMBAL_DEVICE_INFORMATION should be requested.
*/
class STORM32_GIMBAL_MANAGER_INFORMATION{
...
/**
Gimbal device capability flags. Same flags as reported by GIMBAL_DEVICE_INFORMATION. The flag is only
16 bit wide, but stored in 32 bit, for backwards compatibility (high word is zero).
*/
GIMBAL_DEVICE_CAP_FLAGS device_cap_flags;

/**
Gimbal manager capability flags.
*/
MAV_STORM32_GIMBAL_MANAGER_CAP_FLAGS manager_cap_flags;
...
/**
Message reporting the current status of a gimbal manager. This message should be broadcast at a low regular
rate (e.g. 1 Hz, may be increase momentarily to e.g. 5 Hz for a period of 1 sec after a change).
*/
class STORM32_GIMBAL_MANAGER_STATUS{
...
*/
MAV_STORM32_GIMBAL_MANAGER_CLIENT supervisor;

/**
Gimbal device flags currently applied. Same flags as reported by GIMBAL_DEVICE_ATTITUDE_STATUS.
*/
GIMBAL_DEVICE_FLAGS device_flags;

/**
Gimbal manager flags currently applied.
*/
MAV_STORM32_GIMBAL_MANAGER_FLAGS manager_flags;

/**
Profile currently applied (0 = default).
*/
MAV_STORM32_GIMBAL_MANAGER_PROFILE profile;

}

/**
Message to a gimbal manager to control the gimbal attitude. Angles and rates can be set to NaN according
to use case. A gimbal device is never to react to this message.
*/
class STORM32_GIMBAL_MANAGER_CONTROL{
...
/**
Gimbal ID of the gimbal manager to address (component ID or 1-6 for non-MAVLink gimbal, 0 for all gimbals).
...
*/
MAV_STORM32_GIMBAL_MANAGER_CLIENT client;
...
/**
Quaternion components, w, x, y, z (1 0 0 0 is the null-rotation). Set first element to NaN to be ignored.
The frame is determined by the GIMBAL_DEVICE_FLAGS_YAW_IN_xxx_FRAME flags.
*/
[D(4)]  float [] q;
...
/**
Z component of angular velocity (positive: pan to the right). NaN to be ignored. The frame is determined
...
/**
Message to a gimbal manager to control the gimbal tilt and pan angles. Angles and rates can be set to
NaN according to use case. A gimbal device is never to react to this message.
*/
class STORM32_GIMBAL_MANAGER_CONTROL_PITCHYAW{
...
/**
Yaw/pan angle (positive: pan the right). NaN to be ignored. The frame is determined by the GIMBAL_DEVICE_FLAGS_YAW_IN_xxx_FRAME
flags.
*/
 float  yaw;
...
/**
Yaw/pan angular rate (positive: pan to the right). NaN to be ignored. The frame is determined by the GIMBAL_DEVICE_FLAGS_YAW_IN_xxx_FRAME
flags.
*/
 float  yaw_rate;
...
/**
Message to a gimbal manager to correct the gimbal roll angle. This message is typically used to manually
correct for a tilted horizon in operation. A gimbal device is never to react to this message.
*/
class STORM32_GIMBAL_MANAGER_CORRECT_ROLL{
...
**WIP**
*/
class AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_EXT{
...
/**
Passthrough packet buffer. A packet has 6 bytes: uint16_t id + uint32_t data. The array has space for
40 packets.
*/
[D(240)]  byte [] packet_buf;
...
*/
 ushort  param_index_first;

/**
Number of onboard parameters in this array.
*/
 byte  param_array_len;
...
/**
Parameters buffer. Contains a series of variable length parameter blocks, one per parameter, with format
as specified elsewhere.
*/
[D(248)]  byte [] packet_buf;

}

/**
The target_component field can normally be set to 0, so that all components of the system can receive
the message.
        Note: The frequency fields are extensions to ensure that they are located at the
end of the serialized payload and subject to MAVLink's trailing-zero trimming.
*/
class MLRS_RADIO_LINK_STATS{
...
*/
MLRS_RADIO_LINK_STATS_FLAGS flags;
...
/**
Link quality of serial MAVLink data stream from Tx to Rx. Values: 1..100, 0: no link connection, UINT8_MAX:
unknown.
*/
 byte  rx_LQ_ser;
...
/**
Link quality of serial MAVLink data stream from Rx to Tx. Values: 1..100, 0: no link connection, UINT8_MAX:
unknown.
*/
 byte  tx_LQ_ser;
...
/**
The target_system field should normally be set to the system id of the system the link is connected to,
typically the flight controller.
        The target_component field can normally be set to 0, so that
all components of the system can receive the message.
*/
class MLRS_RADIO_LINK_INFORMATION{
...
*/
 ushort  tx_frame_rate;

/**
Frame rate in Hz (frames per second) for Rx to Tx transmission. Normally equal to tx_packet_rate. 0: unknown.
*/
 ushort  rx_frame_rate;

/**
Operation mode as human readable string. Radio link dependent. Terminated by NULL if the string length
is less than 6 chars and WITHOUT NULL termination if the length is exactly 6 chars - applications have
to provide 6+1 bytes storage if the mode is stored as string. Use a zero-length string if not known.
*/
[D(+6)] string  mode_str;

/**
Frequency band as human readable string. Radio link dependent. Terminated by NULL if the string length
is less than 6 chars and WITHOUT NULL termination if the length is exactly 6 chars - applications have
to provide 6+1 bytes storage if the mode is stored as string. Use a zero-length string if not known.
*/
[D(+6)] string  band_str;
...
/**
Maximum data rate of serial stream in bytes/s for Tx to Rx transmission. 0: unknown. UINT16_MAX: data
rate is 64 KBytes/s or larger.
*/
 ushort  tx_ser_data_rate;

/**
Maximum data rate of serial stream in bytes/s for Rx to Tx transmission. 0: unknown. UINT16_MAX: data
rate is 64 KBytes/s or larger.
*/
 ushort  rx_ser_data_rate;

/**
Receive sensitivity of Tx in inverted dBm. 1..255 represents -1..-255 dBm, 0: unknown.
*/
 byte  tx_receive_sensitivity;

/**
Receive sensitivity of Rx in inverted dBm. 1..255 represents -1..-255 dBm, 0: unknown.
*/
 byte  rx_receive_sensitivity;

}

/**
Injected by a radio link endpoint into the MAVLink stream for purposes of flow control. Should be emitted
only by components with component id MAV_COMP_ID_TELEMETRY_RADIO.
**WIP**
*/
class MLRS_RADIO_LINK_FLOW_CONTROL{
...
/**
Altitude above ground, This altitude is measured by a ultrasound, Laser rangefinder or millimeter-wave
radar
*/
 float  ground_alt;
...
*/
class AVSS_DRONE_OPERATION_MODE{
...
*/
 byte  M300_operation_mode;

/**
horsefly operation mode
*/
 byte  horsefly_operation_mode;
...
Magnetometer calibration based on fixed position
        in earth field given by inclination, declination
and intensity.
*/
...
/**
Change flight speed at a given rate. This slews the vehicle at a controllable rate between it's previous
speed and the new one. (affects GUIDED only. Outside GUIDED, aircraft ignores these commands. Designed
for onboard companion-computer command-and-control, not normally operator/GCS control.)
*/
...
altitude and the new one. (affects GUIDED only. Outside GUIDED, aircraft ignores these commands. Designed
for onboard companion-computer command-and-control, not normally operator/GCS control.)
*/
MAV_CMD_GUIDED_CHANGE_ALTITUDE = 43001, 

/**
Change to target heading at a given rate, overriding previous heading/s. This slews the vehicle at a controllable
rate between it's previous heading and the new one. (affects GUIDED only. Exiting GUIDED returns aircraft
to normal behaviour defined elsewhere. Designed for onboard companion-computer command-and-control, not
...
/**
ols that affect torque in different axes).
          Autopilots must NACK this command with MAV_RESULT_TEMPORARILY_REJECTED
while armed.
*/
...
/**
Should be sent in a COMMAND_INT (Expected frame is MAV_FRAME_GLOBAL, and this should be assumed when sent
in COMMAND_LONG).
...
Enable Moving Target Indicators (MTI) on streamed video.
          Support for feature can be checked
with CAMERA_CAP_FLAGS_HAS_MTI, and disabled with MAV_CMD_CAMERA_STOP_MTI.
**WIP**
*/
MAV_CMD_CAMERA_START_MTI = 2020, 

/**
Disable Moving Target Indicators (MTI) on streamed video.
**WIP**
*/
MAV_CMD_CAMERA_STOP_MTI = 2021, 

/**
Circular fence area centered on home. The vehicle must stay inside this area. If home is moved, the fence
moves.
**WIP**
*/
MAV_CMD_NAV_FENCE_HOME_CIRCLE_INCLUSION = 5005, 
...
Set an external estimate of wind direction and speed.
          This might be used to provide an initial
wind estimate to the estimator (EKF) in the case where the vehicle is wind dead-reckoning, extending
the time when operating without GPS before before position drift builds to an unsafe level. For this
use case the command might reasonably be sent every few minutes when operating at altitude, and the value
is cleared if the estimator resets itself.
*/
MAV_CMD_EXTERNAL_WIND_ESTIMATE = 43004, 

/**
Enable or disable a specific estimator sensor fusion source at runtime.
          This allows a GCS or
companion computer to dynamically control which sensors the estimator fuses without changing parameters.
*/
MAV_CMD_ESTIMATOR_SENSOR_ENABLE = 43006, 
...
/**
Command to a gimbal manager to control the gimbal tilt and pan angles. It is possible to set combinations
...
to signal unset. A gimbal device is never to react to this command.
*/
MAV_CMD_STORM32_DO_GIMBAL_MANAGER_CONTROL_PITCHYAW = 60002, 

/**
Command to configure a gimbal manager. A gimbal device is never to react to this command. The selected
profile is reported in the STORM32_GIMBAL_MANAGER_STATUS message.
**WIP**
*/
...
/**
Dummy/temporary MAV_CMD that causes all.xml to correctly import all commands from both ardupilotmega.xml
and development.xml (otherwise only one is imported, for the reasons given in https://github.com/ArduPilot/pymavlink/pull/544#discussion_r2069976980).
...
struct MAV_CMD_DO_SET_RESUME_REPEAT_DIST{
public struct param_1{
public const string label = "Distance";
 public const string description = @"Distance.";
...
public struct param_7{
 ...
 public const string description = @"Set the distance to be repeated on mission resume";

}
struct MAV_CMD_DO_SPRAYER{
public struct param_1{
public const string label = "Sprayer Enable";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "1";
 public const string description = @"0: disable sprayer. 1: enable sprayer.";
...
public struct param_7{
 ...
 public const string description = @"Control attached liquid sprayer";

}
struct MAV_CMD_DO_SEND_SCRIPT_MESSAGE{
public struct param_1{
public const string label = "ID";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "65535";
 public const string description = @"uint16 ID value to be passed to scripting";

}
public struct param_2{
public const string label = "param 1";
 public const string description = @"float value to be passed to scripting";

}
public struct param_3{
public const string label = "param 2";
 public const string description = @"float value to be passed to scripting";

}
public struct param_4{
public const string label = "param 3";
 public const string description = @"float value to be passed to scripting";
...
public struct param_7{
 ...
 public const string description = @"Pass instructions onto scripting, a script should be checking for a new command";

}
struct MAV_CMD_DO_AUX_FUNCTION{
public struct param_1{
public const string label = "AuxiliaryFunction";
 public const string description = @"Auxiliary Function.";

}
public struct param_2{
public const string label = "SwitchPosition";
public const string Enum = "MAV_CMD_DO_AUX_FUNCTION_SWITCH_LEVEL";
 public const string description = @"Switch Level.";
...
public struct param_7{
 ...
 public const string description = @"Execute auxiliary function";

}
struct MAV_CMD_NAV_ALTITUDE_WAIT{
public struct param_1{
public const string label = "Altitude";
 public const string description = @"Altitude.";
...
public struct param_2{
public const string label = "Descent Speed";
 public const string description = @"Descent speed.";

}
public struct param_3{
public const string label = "Wiggle Time";
 public const string description = @"How long to wiggle the control surfaces to prevent them seizing up.";
...
public struct param_7{
 ...
 public const string description = @"Mission command to wait for an altitude or downwards vertical speed. This is meant for high altitude balloon
launches, allowing the aircraft to be idle until either an altitude is reached or a negative vertical
speed is reached (indicating early balloon burst). The wiggle time is how often to wiggle the control
surfaces to prevent them seizing up.";

}
struct MAV_CMD_POWER_OFF_INITIATED{
public struct param_1{
 public const string description = @"Empty.";
...
public struct param_7{
 ...
 public const string description = @"A system wide power-off event has been initiated.";

}
struct MAV_CMD_SOLO_BTN_FLY_CLICK{
public struct param_1{
 public const string description = @"Empty.";
...
public struct param_7{
 ...
 public const string description = @"FLY button has been clicked.";

}
struct MAV_CMD_SOLO_BTN_FLY_HOLD{
public struct param_1{
public const string label = "Takeoff Altitude";
 public const string description = @"Takeoff altitude.";
...
public struct param_7{
 ...
 public const string description = @"FLY button has been held for 1.5 seconds.";

}
struct MAV_CMD_SOLO_BTN_PAUSE_CLICK{
public struct param_1{
public const string label = "Shot Mode";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "1";
 public const string description = @"1 if Solo is in a shot mode, 0 otherwise.";
...
public struct param_7{
 ...
 public const string description = @"PAUSE button has been clicked.";

}
struct MAV_CMD_FIXED_MAG_CAL{
public struct param_1{
public const string label = "Declination";
 public const string description = @"Magnetic declination.";

}
public struct param_2{
public const string label = "Inclination";
 public const string description = @"Magnetic inclination.";

}
public struct param_3{
public const string label = "Intensity";
 public const string description = @"Magnetic intensity.";

}
public struct param_4{
public const string label = "Yaw";
 public const string description = @"Yaw.";
...
public struct param_7{
 ...
 public const string description = @"Magnetometer calibration based on fixed position
        in earth field given by inclination, declination
and intensity.";

}
struct MAV_CMD_FIXED_MAG_CAL_FIELD{
public struct param_1{
public const string label = "Field X";
 public const string description = @"Field strength X.";

}
public struct param_2{
public const string label = "Field Y";
 public const string description = @"Field strength Y.";

}
public struct param_3{
public const string label = "Field Z";
 public const string description = @"Field strength Z.";
...
public struct param_7{
 ...
 public const string description = @"Magnetometer calibration based on fixed expected field values.";

}
struct MAV_CMD_SET_EKF_SOURCE_SET{
public struct param_1{
public const string label = "SourceSetId";
public const string increment = "1";
public const string minValue = "1";
public const string maxValue = "3";
 public const string description = @"Source Set Id.";
...
public struct param_7{
 ...
 public const string description = @"Set EKF sensor source set.";

}
struct MAV_CMD_DO_START_MAG_CAL{
public struct param_1{
public const string label = "Magnetometers Bitmask";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "255";
 public const string description = @"Bitmask of magnetometers to calibrate. Use 0 to calibrate all sensors that can be started (sensors may
not start if disabled, unhealthy, etc.). The command will NACK if calibration does not start for a sensor
explicitly specified by the bitmask.";

}
public struct param_2{
public const string label = "Retry on Failure";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "1";
 public const string description = @"Automatically retry on failure (0=no retry, 1=retry).";

}
public struct param_3{
public const string label = "Autosave";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "1";
 public const string description = @"Save without user input (0=require input, 1=autosave).";
...
public struct param_5{
public const string label = "Autoreboot";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "1";
 public const string description = @"Autoreboot (0=user reboot, 1=autoreboot).";
...
public struct param_7{
 ...
 public const string description = @"Initiate a magnetometer calibration.";

}
struct MAV_CMD_DO_ACCEPT_MAG_CAL{
public struct param_1{
public const string label = "Magnetometers Bitmask";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "255";
 public const string description = @"Bitmask of magnetometers that calibration is accepted (0 means all).";
...
public struct param_7{
 ...
 public const string description = @"Accept a magnetometer calibration.";

}
struct MAV_CMD_DO_CANCEL_MAG_CAL{
public struct param_1{
public const string label = "Magnetometers Bitmask";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "255";
 public const string description = @"Bitmask of magnetometers to cancel a running calibration (0 means all).";
...
public struct param_7{
 ...
 public const string description = @"Cancel a running magnetometer calibration.";

}
struct MAV_CMD_ACCELCAL_VEHICLE_POS{
public struct param_1{
public const string label = "Position";
public const string Enum = "ACCELCAL_VEHICLE_POS";
 public const string description = @"Position.";
...
public struct param_7{
 ...
 public const string description = @"Used when doing accelerometer calibration. When sent to the GCS tells it what position to put the vehicle
in. When sent to the vehicle says what position the vehicle is in.";

}
struct MAV_CMD_DO_SEND_BANNER{
public struct param_1{
 public const string description = @"Empty.";
...
public struct param_7{
 ...
 public const string description = @"Reply with the version banner.";

}
struct MAV_CMD_SET_FACTORY_TEST_MODE{
public struct param_1{
public const string label = "Test Mode";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "1";
 public const string description = @"0: activate test mode, 1: exit test mode.";
...
public struct param_7{
 ...
 public const string description = @"Command autopilot to get into factory test/diagnostic mode.";

}
struct MAV_CMD_GIMBAL_RESET{
public struct param_1{
 public const string description = @"Empty.";
...
public struct param_7{
 ...
 public const string description = @"Causes the gimbal to reset and boot as if it was just powered on.";

}
struct MAV_CMD_GIMBAL_AXIS_CALIBRATION_STATUS{
public struct param_1{
public const string label = "Axis";
public const string Enum = "GIMBAL_AXIS";
 public const string description = @"Gimbal axis we're reporting calibration progress for.";

}
public struct param_2{
public const string label = "Progress";
public const string minValue = "0";
public const string maxValue = "100";
 public const string description = @"Current calibration progress for this axis.";

}
public struct param_3{
public const string label = "Status";
public const string Enum = "GIMBAL_AXIS_CALIBRATION_STATUS";
 public const string description = @"Status of the calibration.";
...
public struct param_7{
 ...
 public const string description = @"Reports progress and success or failure of gimbal axis calibration procedure.";

}
struct MAV_CMD_GIMBAL_REQUEST_AXIS_CALIBRATION{
public struct param_1{
 public const string description = @"Empty.";
...
public struct param_7{
 ...
 public const string description = @"Starts commutation calibration on the gimbal.";

}
struct MAV_CMD_GIMBAL_FULL_RESET{
public struct param_1{
 public const string description = @"Magic number.";
...
public struct param_7{
 ...
 public const string description = @"Erases gimbal application and parameters.";

}
struct MAV_CMD_FLASH_BOOTLOADER{
public struct param_1{
 public const string description = @"Empty";
...
public struct param_5{
public const string label = "Magic Number";
public const string increment = "1";
 public const string description = @"Magic number - set to 290876 to actually flash";
...
public struct param_7{
 ...
 public const string description = @"Update the bootloader";

}
struct MAV_CMD_BATTERY_RESET{
public struct param_1{
public const string label = "battery mask";
 public const string description = @"Bitmask of batteries to reset. Least significant bit is for the first battery.";

}
public struct param_2{
public const string label = "percentage";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "100";
 public const string description = @"Battery percentage remaining to set.";

}

 public const string description = @"Reset battery capacity for batteries that accumulate consumed battery via integration.";

}
struct MAV_CMD_DEBUG_TRAP{
public struct param_1{
 public const string description = @"Magic number - set to 32451 to actually trap.";
...
public struct param_7{
 ...
 public const string description = @"Issue a trap signal to the autopilot process, presumably to enter the debugger.";

}
struct MAV_CMD_SCRIPTING{
public struct param_1{
public const string Enum = "SCRIPTING_CMD";
 public const string description = @"Scripting command to execute";

}

 public const string description = @"Control onboard scripting.";

}
struct MAV_CMD_NAV_SCRIPT_TIME{
public struct param_1{
public const string label = "command";
 public const string description = @"integer command number (0 to 255)";

}
public struct param_2{
public const string label = "timeout";
 public const string description = @"timeout for operation in seconds. Zero means no timeout (0 to 255)";

}
public struct param_3{
public const string label = "arg1";
 public const string description = @"argument1.";

}
public struct param_4{
public const string label = "arg2";
 public const string description = @"argument2.";

}
public struct param_5{
public const string label = "arg3";
 public const string description = @"argument3.";

}
public struct param_6{
public const string label = "arg4";
 public const string description = @"argument4.";
...
public struct param_7{
 ...
 public const string description = @"Scripting command as NAV command with wait for completion.";

}
struct MAV_CMD_NAV_ATTITUDE_TIME{
public struct param_1{
public const string label = "time";
 public const string description = @"Time to maintain specified attitude and climb rate";

}
public struct param_2{
public const string label = "roll";
 public const string description = @"Roll angle in degrees (positive is lean right, negative is lean left)";

}
public struct param_3{
public const string label = "pitch";
 public const string description = @"Pitch angle in degrees (positive is lean back, negative is lean forward)";

}
public struct param_4{
public const string label = "yaw";
 public const string description = @"Yaw angle";

}
public struct param_5{
public const string label = "climb_rate";
 public const string description = @"Climb rate";
...
public struct param_7{
 ...
 public const string description = @"Maintain an attitude for a specified time.";

}
struct MAV_CMD_GUIDED_CHANGE_SPEED{
public struct param_1{
public const string label = "speed type";
public const string Enum = "SPEED_TYPE";
 public const string description = @"Airspeed or groundspeed.";

}
public struct param_2{
public const string label = "speed target";
 public const string description = @"Target Speed";

}
public struct param_3{
public const string label = "speed rate-of-change";
 public const string description = @"Acceleration rate, 0 to take effect instantly";
...
public struct param_7{
 ...
 public const string description = @"Change flight speed at a given rate. This slews the vehicle at a controllable rate between it's previous
speed and the new one. (affects GUIDED only. Outside GUIDED, aircraft ignores these commands. Designed
for onboard companion-computer command-and-control, not normally operator/GCS control.)";

}
struct MAV_CMD_GUIDED_CHANGE_ALTITUDE{
public struct param_1{
 public const string description = @"Empty";
...
public struct param_3{
public const string label = "alt rate-of-change";
public const string minValue = "0";
 public const string description = @"Rate of change, toward new altitude. 0 for maximum rate change. Positive numbers only, as negative numbers
will not converge on the new target alt.";
...
public struct param_7{
public const string label = "target alt";
 public const string description = @"Target Altitude";

}

 public const string description = @"Change target altitude at a given rate. This slews the vehicle at a controllable rate between it's previous
altitude and the new one. (affects GUIDED only. Outside GUIDED, aircraft ignores these commands. Designed
for onboard companion-computer command-and-control, not normally operator/GCS control.)";

}
struct MAV_CMD_GUIDED_CHANGE_HEADING{
public struct param_1{
public const string label = "heading type";
public const string Enum = "HEADING_TYPE";
 public const string description = @"course-over-ground or raw vehicle heading.";

}
public struct param_2{
public const string label = "heading target";
public const string minValue = "0";
public const string maxValue = "359.99";
 public const string description = @"Target heading.";

}
public struct param_3{
public const string label = "heading rate-of-change";
 public const string description = @"Maximum centripetal accelearation, ie rate of change,  toward new heading.";
...
public struct param_7{
 ...
 public const string description = @"Change to target heading at a given rate, overriding previous heading/s. This slews the vehicle at a controllable
rate between it's previous heading and the new one. (affects GUIDED only. Exiting GUIDED returns aircraft
to normal behaviour defined elsewhere. Designed for onboard companion-computer command-and-control, not
normally operator/GCS control.)";

}
struct MAV_CMD_SET_HAGL{
public struct param_1{
public const string label = "hagl";
 public const string description = @"Height above ground level.";
...
public struct param_3{
public const string label = "timeout";
 public const string description = @"Timeout for this data. The flight controller should only consider this data valid within the timeout window.";
...
public struct param_7{
 ...
 public const string description = @"Provide a value for height above ground level. This can be used for things like fixed wing and VTOL landing.";
...
struct MAV_CMD_ACTUATOR_GROUP_TEST{
public struct param_1{
public const string label = "Group";
public const string Enum = "ACTUATOR_TEST_GROUP";
 public const string description = @"Actuator group to check, such as actuators related to roll torque.";
...
public const string minValue = "-1";
public const string maxValue = "1";
 public const string description = @"Value to set. This is a normalized value across the full range of the tested group [-1,1].";

}

 public const string description = @"ols that affect torque in different axes).
          Autopilots must NACK this command with MAV_RESULT_TEMPORARILY_REJECTED
while armed.";

}
struct MAV_CMD_DO_SET_SYS_CMP_ID{
public struct param_1{
public const string label = "System ID";
public const string increment = "1";
public const string minValue = "1";
public const string maxValue = "255";
 public const string description = @"New system ID for target component(s). 0: ignore and reject command (broadcast system ID not allowed).";
...
public const string minValue = "0";
public const string maxValue = "255";
 public const string description = @"New component ID for target component(s). 0: ignore (component IDs don't change).";

}
public struct param_3{
public const string label = "Reboot";
 public const string description = @"Reboot components after ID change. Any non-zero value triggers the reboot.";
...
public const string Default = "NaN";
 ...
 public const string description = @"Recipients must reject command addressed to broadcast system ID.
        ";

}
struct MAV_CMD_DO_SET_GLOBAL_ORIGIN{
public struct param_1{
 public const string description = @"Empty";
...
public const string label = "Altitude";
 ...
 public const string description = @"Should be sent in a COMMAND_INT (Expected frame is MAV_FRAME_GLOBAL, and this should be assumed when sent
in COMMAND_LONG).
        ";

}
struct MAV_CMD_CAMERA_START_MTI{
public struct param_1{
public const string label = "Target Camera ID";
public const string increment = "1";
public const string minValue = "0";
...
cameras. It is also used to target specific cameras when the MAV_CMD is used in a mission.";
 ...
 public const string description = @"Enable Moving Target Indicators (MTI) on streamed video.
          Support for feature can be checked
with CAMERA_CAP_FLAGS_HAS_MTI, and disabled with MAV_CMD_CAMERA_STOP_MTI.";

}
struct MAV_CMD_CAMERA_STOP_MTI{
public struct param_1{
public const string label = "Target Camera ID";
public const string increment = "1";
public const string minValue = "0";
...
cameras. It is also used to target specific cameras when the MAV_CMD is used in a mission.";
 ...
 public const string description = @"Disable Moving Target Indicators (MTI) on streamed video.";

}
struct MAV_CMD_NAV_FENCE_HOME_CIRCLE_INCLUSION{
public struct param_1{
public const string label = "Radius";
 public const string description = @"Radius.";
...
public const string minValue = "0";
 public const string description = @"Vehicle must be inside ALL inclusion zones in a single group, vehicle must be inside at least one group.
Ignored when sent as a command.";

}

 public const string description = @"Circular fence area centered on home. The vehicle must stay inside this area. If home is moved, the fence
moves.";

}
struct MAV_CMD_ODID_SET_EMERGENCY{
public struct param_1{
public const string label = "Number";
public const string increment = "1";
public const string minValue = "0";
 public const string description = @"Set/unset emergency 0: unset, 1: set";
...
struct MAV_CMD_EXTERNAL_WIND_ESTIMATE{
public struct param_1{
public const string label = "Wind speed";
public const string minValue = "0";
 public const string description = @"Horizontal wind speed.";

}
public struct param_2{
public const string label = "Wind speed accuracy";
 public const string description = @"Estimated 1 sigma accuracy of wind speed. Set to NaN if unknown.";
...
public const string minValue = "0";
public const string maxValue = "360";
 public const string description = @"Azimuth (relative to true north) from where the wind is blowing.";

}
public struct param_4{
public const string label = "Direction accuracy";
 public const string description = @"Estimated 1 sigma accuracy of wind direction. Set to NaN if unknown.";
...
public struct param_7{
 ...
 public const string description = @"Set an external estimate of wind direction and speed.
          This might be used to provide an initial
wind estimate to the estimator (EKF) in the case where the vehicle is wind dead-reckoning, extending
the time when operating without GPS before before position drift builds to an unsafe level. For this
use case the command might reasonably be sent every few minutes when operating at altitude, and the value
...
struct MAV_CMD_ESTIMATOR_SENSOR_ENABLE{
public struct param_1{
public const string label = "Source";
public const string Enum = "ESTIMATOR_SENSOR_FUSION_SOURCE";
public const string increment = "1";
public const string minValue = "0";
 public const string description = @"Sensor fusion source type.";
...
public const string increment = "1";
public const string minValue = "0";
 public const string description = @"Sensor instance (0-based, for multi-instance).";

}
public struct param_3{
public const string label = "Enable";
public const string Enum = "MAV_BOOL";
 public const string description = @"Enable (1) or Disable (0) the source.";

}
public struct param_4{
public const string label = "Estimator Instance";
public const string increment = "1";
public const string minValue = "0";
public const string Default = "NaN";
 public const string description = @"Estimator instance (0-based, for systems with multiple estimators).";
...
public struct param_7{
 ...
 public const string description = @"Enable or disable a specific estimator sensor fusion source at runtime.
          This allows a GCS or
companion computer to dynamically control which sensors the estimator fuses without changing parameters.";

}
struct MAV_CMD_EXTERNAL_ATTITUDE_ESTIMATE{
public struct param_1{
public const string label = "Roll";
public const string minValue = "0";
public const string maxValue = "360";
 public const string description = @"Roll angle. Set to NaN if unknown.";
...
public const string minValue = "0";
public const string maxValue = "360";
 public const string description = @"Pitch angle. Set to NaN if unknown.";
...
public const string minValue = "0";
public const string maxValue = "360";
 public const string description = @"Yaw/heading (relative to true north) angle. Set to NaN if unknown.";

}
public struct param_4{
public const string label = "Tilt accuracy";
 public const string description = @"Estimated 1 sigma accuracy of roll and pitch angles. Set to NaN if unknown.";
...
public struct param_7{
public const string label = "Yaw accuracy";
 public const string description = @"Estimated 1 sigma accuracy of yaw angle. Set to NaN if unknown.";

}

 public const string description = @"Set an external estimate of vehicle attitude.
          This might be used to provide an initial attitude
(especially heading) estimate to the estimator (EKF). Angles are defined in a 3-2-1 (yaw-pitch-roll)
intrinsic Tait-Bryan sequence.";

}
struct MAV_CMD_REQUEST_OPERATOR_CONTROL{
public struct param_1{
public const string label = "Action";
 public const string description = @"0: Release control, 1: Request control.";

}
public struct param_2{
public const string label = "Allow takeover";
 public const string description = @"Enable automatic granting of ownership on request (by default reject request and notify current owner).
0: Ask current owner and reject request, 1: Allow automatic takeover.";

}
public struct param_3{
public const string label = "Request timeout";
public const string minValue = "3";
public const string maxValue = "60";
 public const string description = @"Timeout in seconds before a request to a GCS to allow takeover is assumed to be rejected. This is used
to display the timeout graphically on requester and GCS in control.";

}
public struct param_4{
public const string label = "GCS Sysid";
 public const string description = @"System ID of GCS requesting control. For a range of GCS in control, this the minimum id (and the sender
system ID may be anywhere in the range).";

}
public struct param_5{
public const string label = "GCS Sysid (upper range)";
 public const string description = @"Upper range of controlling GCS system IDs. 0 for single-GCS control. If non-zero the sender system ID
may be anywhere in the range).";
...
public struct param_7{
 ...
 public const string description = @"The flow is otherwise the same as for requesting control over the whole system.
        ";

}
struct MAV_CMD_STORM32_DO_GIMBAL_MANAGER_CONTROL_PITCHYAW{
public struct param_1{
public const string label = "Pitch angle";
public const string minValue = "-180";
public const string maxValue = "180";
 public const string description = @"Pitch/tilt angle (positive: tilt up). NaN to be ignored.";
...
public const string minValue = "-180";
public const string maxValue = "180";
 public const string description = @"Yaw/pan angle (positive: pan to the right). NaN to be ignored. The frame is determined by the GIMBAL_DEVICE_FLAGS_YAW_IN_xxx_FRAME
flags.";

}
public struct param_3{
public const string label = "Pitch rate";
 public const string description = @"Pitch/tilt rate (positive: tilt up). NaN to be ignored.";

}
public struct param_4{
public const string label = "Yaw rate";
 public const string description = @"Yaw/pan rate (positive: pan to the right). NaN to be ignored. The frame is determined by the GIMBAL_DEVICE_FLAGS_YAW_IN_xxx_FRAME
flags.";

}
public struct param_5{
public const string label = "Gimbal device flags";
public const string Enum = "GIMBAL_DEVICE_FLAGS";
 public const string description = @"Gimbal device flags to be applied.";

}
public struct param_6{
public const string label = "Gimbal manager flags";
public const string Enum = "MAV_STORM32_GIMBAL_MANAGER_FLAGS";
 public const string description = @"Gimbal manager flags to be applied.";

}
public struct param_7{
public const string label = "Gimbal ID and client";
 public const string description = @"Gimbal ID of the gimbal manager to address (component ID or 1-6 for non-MAVLink gimbal, 0 for all gimbals).
Send command multiple times for more than one but not all gimbals. The client is copied into bits 8-15.";

}

 public const string description = @"Command to a gimbal manager to control the gimbal tilt and pan angles. It is possible to set combinations
of the values below. E.g. an angle as well as a desired angular rate can be used to get to this angle
at a certain angular rate, or an angular rate only will result in continuous turning. NaN is to be used
to signal unset. A gimbal device is never to react to this command.";

}
struct MAV_CMD_STORM32_DO_GIMBAL_MANAGER_SETUP{
public struct param_1{
public const string label = "Profile";
public const string Enum = "MAV_STORM32_GIMBAL_MANAGER_PROFILE";
 public const string description = @"Gimbal manager profile (0 = default).";

}
public struct param_7{
public const string label = "Gimbal ID";
 public const string description = @"Gimbal ID of the gimbal manager to address (component ID or 1-6 for non-MAVLink gimbal, 0 for all gimbals).
Send command multiple times for more than one but not all gimbals.";

}

 public const string description = @"Command to configure a gimbal manager. A gimbal device is never to react to this command. The selected
profile is reported in the STORM32_GIMBAL_MANAGER_STATUS message.";

}
struct MAV_CMD_QSHOT_DO_CONFIGURE{
public struct param_1{
public const string label = "Mode";
public const string Enum = "MAV_QSHOT_MODE";
 public const string description = @"Set shot mode.";

}
public struct param_2{
public const string label = "Shot state or command";
 public const string description = @"Set shot state or command. The allowed values are specific to the selected shot mode.";

}

 public const string description = @"Command to set the shot manager mode.";
...
public struct param_7{
 ...
 public const string description = @"AVSS defined command. Shuts down the PRS system.";

}
struct MAV_CMD_DUMMY_ALL{

 public const string description = @"Dummy/temporary MAV_CMD that causes all.xml to correctly import all commands from both ardupilotmega.xml
and development.xml (otherwise only one is imported, for the reasons given in https://github.com/ArduPilot/pymavlink/pull/544#discussion_r2069976980).
