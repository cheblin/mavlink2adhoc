...
*/
interface CHANGE_OPERATOR_CONTROL{
...
*/
interface CHANGE_OPERATOR_CONTROL_ACK{
...
*/
interface MISSION_REQUEST_PARTIAL_LIST{
...
be REJECTED!
*/
interface MISSION_WRITE_PARTIAL_LIST{
...
*/
interface MISSION_REQUEST_LIST{
...
*/
interface MISSION_ITEM_REACHED{
...
*/
interface SET_GPS_GLOBAL_ORIGIN{
...
*/
interface SAFETY_SET_ALLOWED_AREA{
...
Quaternion order is w, x, y, z and a zero rotation would be expressed as (1 0 0 0).
*/
interface ATTITUDE_QUATERNION_COV{
...
*/
interface NAV_CONTROLLER_OUTPUT{
...
*/
interface GLOBAL_POSITION_INT_COV{
...
Z-axis down (aeronautical frame, NED / north-east-down convention)
*/
interface LOCAL_POSITION_NED_COV{
...
*/
interface RC_CHANNELS_OVERRIDE{
...
*/
interface SET_POSITION_TARGET_LOCAL_NED{
...
this way.
*/
interface POSITION_TARGET_LOCAL_NED{
...
*/
interface SET_POSITION_TARGET_GLOBAL_INT{
...
this way.
*/
interface POSITION_TARGET_GLOBAL_INT{
...
convention)
*/
interface LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET{
...
*/
interface HIL_ACTUATOR_CONTROLS{
...
*/
interface GLOBAL_VISION_POSITION_ESTIMATE{
...
*/
interface VISION_POSITION_ESTIMATE{
...
*/
interface VISION_SPEED_ESTIMATE{
...
*/
interface VICON_POSITION_ESTIMATE{
...
*/
interface FILE_TRANSFER_PROTOCOL{
...
*/
interface HIL_STATE_QUATERNION{
...
*/
interface DATA_TRANSMISSION_HANDSHAKE{
...
*/
interface SET_ACTUATOR_CONTROL_TARGET{
...
Set the vehicle attitude and body angular rates.
*/
interface ACTUATOR_CONTROL_TARGET{
...
*/
interface CONTROL_SYSTEM_STATE{
...
*/
interface CAMERA_CAPTURE_STATUS{
...
*/
interface CAMERA_IMAGE_CAPTURED{
...
*/
interface VIDEO_STREAM_INFORMATION{
...
interval.
*/
interface CAMERA_TRACKING_IMAGE_STATUS{
...
interval.
*/
interface CAMERA_TRACKING_GEO_STATUS{
...
*/
interface GIMBAL_MANAGER_INFORMATION{
...
(e.g. 5Hz).
*/
interface GIMBAL_MANAGER_STATUS{
...
*/
interface GIMBAL_MANAGER_SET_ATTITUDE{
...
*/
interface GIMBAL_DEVICE_INFORMATION{
...
*/
interface GIMBAL_DEVICE_SET_ATTITUDE{
...
*/
interface GIMBAL_DEVICE_ATTITUDE_STATUS{
...
*/
interface AUTOPILOT_STATE_FOR_GIMBAL_DEVICE{
...
*/
interface GIMBAL_MANAGER_SET_PITCHYAW{
...
*/
interface GIMBAL_MANAGER_SET_MANUAL_CONTROL{
...
*/
interface PARAM_EXT_REQUEST_READ{
...
*/
interface PARAM_EXT_REQUEST_LIST{
...
*/
interface TRAJECTORY_REPRESENTATION_WAYPOINTS{
...
*/
interface TRAJECTORY_REPRESENTATION_BEZIER{
...
*/
interface ORBIT_EXECUTION_STATUS{
...
SERVO_OUTPUT_RAW.
*/
interface ACTUATOR_OUTPUT_STATUS{
...
*/
interface TIME_ESTIMATE_TO_TARGET{
...
*/
interface ONBOARD_COMPUTER_STATUS{
...
*/
interface COMPONENT_INFORMATION{
...
for dropped events.
*/
interface CURRENT_EVENT_SEQUENCE{
...
*/
interface RESPONSE_EVENT_ERROR{
...
*/
interface OPEN_DRONE_ID_BASIC_ID{
...
*/
interface OPEN_DRONE_ID_LOCATION{
...
*/
interface OPEN_DRONE_ID_AUTHENTICATION{
...
or manner.
*/
interface OPEN_DRONE_ID_SELF_ID{
...
*/
interface OPEN_DRONE_ID_SYSTEM{
...
issued operator ID.
*/
interface OPEN_DRONE_ID_OPERATOR_ID{
...
Aware Networking.
*/
interface OPEN_DRONE_ID_MESSAGE_PACK{
...
*/
interface UAVIONIX_ADSB_OUT_CFG{
...
*/
interface UAVIONIX_ADSB_OUT_DYNAMIC{
...
*/
interface UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT{
...
*/
interface AUTOPILOT_VERSION_REQUEST{
...
*/
interface REMOTE_LOG_DATA_BLOCK{
...
*/
interface REMOTE_LOG_BLOCK_STATUS{
...
*/
interface GIMBAL_TORQUE_CMD_REPORT{
...
*/
interface DEVICE_OP_READ_REPLY{
...
*/
interface DEVICE_OP_WRITE_REPLY{
...
*/
interface VISION_POSITION_DELTA{
...
*/
interface ESC_TELEMETRY_1_TO_4{

/**
Temperature.
*/
[Dims( +4 )]  byte  temperature();

/**
Voltage.
*/
[Dims( +4 )]  ushort  voltage();

/**
Current.
*/
[Dims( +4 )]  ushort  current();

/**
Total current.
*/
[Dims( +4 )]  ushort  totalcurrent();
...
*/
interface ESC_TELEMETRY_5_TO_8{
...
*/
interface ESC_TELEMETRY_9_TO_12{
...
*/
interface OSD_PARAM_CONFIG_REPLY{
...
*/
interface OSD_PARAM_SHOW_CONFIG{
...
*/
interface OSD_PARAM_SHOW_CONFIG_REPLY{
...
*/
interface OBSTACLE_DISTANCE_3D{
...
*/
interface COMMAND_LONG_STAMPED{
...
*/
interface SENSOR_AIRFLOW_ANGLES{
...
*/
enum AIRSPEED_SENSOR_TYPE{

/**
Airspeed sensor type unknown/not supplied.
*/
AIRSPEED_SENSOR_TYPE_UNKNOWN = 0, 

/**
Differential airspeed sensor
*/
AIRSPEED_SENSOR_TYPE_DIFFERENTIAL = 1, 

/**
Mass-flow airspeed sensor.
*/
AIRSPEED_SENSOR_TYPE_MASS_FLOW = 2, 

/**
Windvane airspeed sensor.
*/
AIRSPEED_SENSOR_TYPE_WINDVANE = 3, 

/**
Synthetic/calculated airspeed.
*/
AIRSPEED_SENSOR_TYPE_SYNTHETIC = 4, 
...
It may also automatically land the vehicle (i.e. RTL).
          The precise flight path and landing behaviour
depend on vehicle configuration and type.
*/
MAV_STANDARD_MODE_RETURN_HOME = 5, 

/**
It may also automatically land the vehicle.
          The precise return location, flight path, and landing
behaviour depend on vehicle configuration and type.
*/
...
*/
interface PARAM_ACK_TRANSACTION{
...
/**
The checksum for the whole plan (MAV_MISSION_TYPE_ALL) is calculated using the same approach, running
over each sub-plan in the following order: mission, geofence then rally point.
      
*/
interface MISSION_CHECKSUM{
...
/**
Airspeed sensor type. NaN for value unknown/not supplied. Used to estimate accuracy (i.e. as an alternative
to using the error field).
*/
AIRSPEED_SENSOR_TYPE Typ();

}

/**
Detected WiFi network status information. This message is sent per each WiFi network detected in range
with known SSID and general status parameters.
*/
interface WIFI_NETWORK_INFO{
...
*/
WIFI_NETWORK_SECURITY security();
...
*/
interface COMPONENT_INFORMATION_BASIC{
...
*/
enum MAV_STORM32_GIMBAL_PREARM_FLAGS{
...
*/
enum MAV_STORM32_CAMERA_PREARM_FLAGS{
...
*/
enum MAV_STORM32_GIMBAL_DEVICE_CAP_FLAGS{
...
/**
Gimbal device supports a horizontal, forward looking position, stabilized. Can also be used to reset the
...
/**
Gimbal device supports absolute yaw angles (this usually requires support by an autopilot, and can be
dynamic, i.e., go on and off during runtime).
*/
...
/**
Flags for gimbal device operation. Used for setting and reporting, unless specified otherwise. Settings
which are in violation of the capability flags are ignored by the gimbal device.
*/
enum MAV_STORM32_GIMBAL_DEVICE_FLAGS{

/**
Retracted safe position (no stabilization), takes presedence over NEUTRAL flag. If supported by the gimbal,
the angles in the retracted position can be set in addition.
*/
...
/**
Lock yaw angle to absolute angle relative to earth (not relative to drone). When the YAW_ABSOLUTE flag
is set, the quaternion is in the Earth frame with the x-axis pointing North (yaw absolute), else it is
in the Earth frame rotated so that the x-axis is pointing forward (yaw relative to vehicle).
*/
MAV_STORM32_GIMBAL_DEVICE_FLAGS_YAW_LOCK = 16, 

/**
Gimbal device can accept absolute yaw angle input. This flag cannot be set, is only for reporting (attempts
to set it are rejected by the gimbal device).
*/
MAV_STORM32_GIMBAL_DEVICE_FLAGS_CAN_ACCEPT_YAW_ABSOLUTE = 256, 

/**
Yaw angle is absolute (is only accepted if CAN_ACCEPT_YAW_ABSOLUTE is set). If this flag is set, the quaternion
is in the Earth frame with the x-axis pointing North (yaw absolute), else it is in the Earth frame rotated
so that the x-axis is pointing forward (yaw relative to vehicle).
*/
MAV_STORM32_GIMBAL_DEVICE_FLAGS_YAW_ABSOLUTE = 512, 

/**
RC control. The RC input signal fed to the gimbal device exclusively controls the gimbal's orientation.
Overrides RC_MIXED flag if that is also set.
*/
MAV_STORM32_GIMBAL_DEVICE_FLAGS_RC_EXCLUSIVE = 1024, 

/**
RC control. The RC input signal fed to the gimbal device is mixed into the gimbal's orientation. Is overriden
by RC_EXCLUSIVE flag if that is also set.
*/
...
*/
enum MAV_STORM32_GIMBAL_DEVICE_ERROR_FLAGS{
...
is accepted by the gimbal manger, is reported in the STORM32_GIMBAL_MANAGER_STATUS message.
*/
...
*/
enum MAV_STORM32_GIMBAL_MANAGER_SETUP_FLAGS{
...
/**
Default cooperative profile. Uses STorM32 custom profile with default settings to achieve cooperative
behavior.
*/
...
/**
Default priority profile with cooperative behavior for equal priority. Uses STorM32 custom profile with
default settings to achieve priority-based behavior.
*/
MAV_STORM32_GIMBAL_MANAGER_PROFILE_PRIORITY_COOPERATIVE = 4, 

/**
Default priority profile with exclusive behavior for equal priority. Uses STorM32 custom profile with
default settings to achieve priority-based behavior.
*/
...
Gimbal actions.
*/
enum MAV_STORM32_GIMBAL_ACTION{
...
/**
Message reporting the current status of a gimbal device. This message should be broadcasted by a gimbal
device component at a low regular rate (e.g. 4 Hz). For higher rates it should be emitted with a target.
*/
interface STORM32_GIMBAL_DEVICE_STATUS{
...
*/
MAV_STORM32_GIMBAL_DEVICE_FLAGS flags();

/**
Quaternion components, w, x, y, z (1 0 0 0 is the null-rotation). The frame depends on the STORM32_GIMBAL_DEVICE_FLAGS_YAW_ABSOLUTE
flag.
*/
[Dims( +4 )]  float  q();
...
/**
Z component of angular velocity (the frame depends on the STORM32_GIMBAL_DEVICE_FLAGS_YAW_ABSOLUTE flag,
NaN if unknown).
*/
 float  angular_velocity_z();
...
/**
Message to a gimbal device to control its attitude. This message is to be sent from the gimbal manager
to the gimbal device. Angles and rates can be set to NaN according to use case.
*/
interface STORM32_GIMBAL_DEVICE_CONTROL{
...
/**
Quaternion components, w, x, y, z (1 0 0 0 is the null-rotation, the frame is determined by the STORM32_GIMBAL_DEVICE_FLAGS_YAW_ABSOLUTE
flag, set first element to NaN to be ignored).
*/
[Dims( +4 )]  float  q();
...
It mirrors some fields of the STORM32_GIMBAL_DEVICE_INFORMATION message, but not all. If the additional
information is desired, also STORM32_GIMBAL_DEVICE_INFORMATION should be requested.
*/
interface STORM32_GIMBAL_MANAGER_INFORMATION{
...
Gimbal device capability flags.
*/
MAV_STORM32_GIMBAL_DEVICE_CAP_FLAGS device_cap_flags();
...
/**
Hardware minimum yaw/pan angle (positive: pan to the right, relative to the vehicle/gimbal base, NaN if
unknown).
*/
 float  yaw_min();

/**
Hardware maximum yaw/pan angle (positive: pan to the right, relative to the vehicle/gimbal base, NaN if
unknown).
*/
 float  yaw_max();
...
*/
interface STORM32_GIMBAL_MANAGER_STATUS{
...
Gimbal device flags currently applied.
*/
MAV_STORM32_GIMBAL_DEVICE_FLAGS device_flags();
...
*/
interface STORM32_GIMBAL_MANAGER_CONTROL{
...
/**
Quaternion components, w, x, y, z (1 0 0 0 is the null-rotation, the frame is determined by the GIMBAL_MANAGER_FLAGS_ABSOLUTE_YAW
flag, set first element to NaN to be ignored).
*/
[Dims( +4 )]  float  q();
...
*/
interface STORM32_GIMBAL_MANAGER_CONTROL_PITCHYAW{
...
/**
Yaw/pan angle (positive: pan the right, the frame is determined by the STORM32_GIMBAL_DEVICE_FLAGS_YAW_ABSOLUTE
flag, NaN to be ignored).
*/
 float  yaw();
...
/**
Yaw/pan angular rate (positive: pan to the right, the frame is determined by the STORM32_GIMBAL_DEVICE_FLAGS_YAW_ABSOLUTE
flag, NaN to be ignored).
*/
 float  yaw_rate();
...
*/
interface STORM32_GIMBAL_MANAGER_CORRECT_ROLL{
...
/**
Message to set a gimbal manager profile. A gimbal device is never to react to this command. The selected
profile is reported in the STORM32_GIMBAL_MANAGER_STATUS message.
*/
interface STORM32_GIMBAL_MANAGER_PROFILE{
...
*/
interface COMPONENT_PREARM_STATUS{
...
*/
interface AVSS_DRONE_OPERATION_MODE{
...
/**
Request to start or end a parameter transaction. Multiple kinds of transport layers can be used to exchange
parameters in the transaction (param, param_ext and mavftp). The command response can either be a success/failure
or an in progress in case the receiving side takes some time to apply the parameters.
*/
MAV_CMD_PARAM_TRANSACTION = 900, 

/**
Note: Every geofence in a plan can have its own action; if no fence action is defined for a particular
fence the system-default will be used.
          Note: The flight stack should reject a plan or command
that uses a geofence action that it does not support and send a STATUSTEXT with the reason.
*/
MAV_CMD_SET_FENCE_BREACH_ACTION = 5010, 

/**
The system doing the upgrade will report progress using the normal command protocol sequence for a long
running operation.
...
Enable the specified standard MAVLink mode.
          If the mode is not supported the vehicle should
ACK with MAV_RESULT_FAILED.
*/
...
/**
Command to initiate gimbal actions. Usually performed by the gimbal device, but some can also be done
by the gimbal manager. It is hence best to broadcast this command.
*/
...
interface MAV_CMD_DO_SET_RESUME_REPEAT_DIST{
public interface param_1{
public const string label = "Distance";
 public const string description = @"Distance.";
...
interface MAV_CMD_DO_SEND_SCRIPT_MESSAGE{
public interface param_1{
public const string label = "ID";
public const string increment = "1";
public const string minValue = "0";
...
interface MAV_CMD_DO_AUX_FUNCTION{
public interface param_1{
...
interface MAV_CMD_NAV_ALTITUDE_WAIT{
public interface param_1{
public const string label = "Altitude";
 public const string description = @"Altitude.";
...
interface MAV_CMD_POWER_OFF_INITIATED{
public interface param_1{
 public const string description = @"Empty.";
...
interface MAV_CMD_SOLO_BTN_FLY_CLICK{
public interface param_1{
 public const string description = @"Empty.";
...
interface MAV_CMD_SOLO_BTN_FLY_HOLD{
public interface param_1{
...
interface MAV_CMD_SOLO_BTN_PAUSE_CLICK{
public interface param_1{
...
interface MAV_CMD_FIXED_MAG_CAL{
public interface param_1{
...
interface MAV_CMD_FIXED_MAG_CAL_FIELD{
public interface param_1{
...
interface MAV_CMD_SET_EKF_SOURCE_SET{
public interface param_1{
...
interface MAV_CMD_DO_START_MAG_CAL{
public interface param_1{
...
interface MAV_CMD_DO_ACCEPT_MAG_CAL{
public interface param_1{
public const string label = "Magnetometers Bitmask";
public const string increment = "1";
public const string minValue = "0";
...
interface MAV_CMD_DO_CANCEL_MAG_CAL{
public interface param_1{
public const string label = "Magnetometers Bitmask";
public const string increment = "1";
public const string minValue = "0";
...
interface MAV_CMD_ACCELCAL_VEHICLE_POS{
public interface param_1{
public const string label = "Position";
...
interface MAV_CMD_DO_SEND_BANNER{
public interface param_1{
 public const string description = @"Empty.";
...
interface MAV_CMD_SET_FACTORY_TEST_MODE{
public interface param_1{
...
interface MAV_CMD_GIMBAL_RESET{
public interface param_1{
 public const string description = @"Empty.";
...
interface MAV_CMD_GIMBAL_AXIS_CALIBRATION_STATUS{
public interface param_1{
public const string label = "Axis";
...
interface MAV_CMD_GIMBAL_REQUEST_AXIS_CALIBRATION{
public interface param_1{
 public const string description = @"Empty.";
...
interface MAV_CMD_GIMBAL_FULL_RESET{
public interface param_1{
...
interface MAV_CMD_FLASH_BOOTLOADER{
public interface param_1{
 public const string description = @"Empty";
...
interface MAV_CMD_BATTERY_RESET{
public interface param_1{
...
interface MAV_CMD_NAV_SCRIPT_TIME{
public interface param_1{
...
interface MAV_CMD_GUIDED_CHANGE_SPEED{
public interface param_1{
public const string label = "speed type";
...
interface MAV_CMD_GUIDED_CHANGE_ALTITUDE{
public interface param_1{
 public const string description = @"Empty";
...
interface MAV_CMD_GUIDED_CHANGE_HEADING{
public interface param_1{
...
interface MAV_CMD_PAYLOAD_CONTROL{
public interface param_1{
...
interface MAV_CMD_PARAM_TRANSACTION{
public interface param_1{
public const string label = "Action";
public const string Enum = "PARAM_TRANSACTION_ACTION";
 public const string description = @"Action to be performed (start, commit, cancel, etc.)";

}
public interface param_2{
public const string label = "Transport";
public const string Enum = "PARAM_TRANSACTION_TRANSPORT";
 public const string description = @"Possible transport layers to set and get parameters via mavlink during a parameter transaction.";

}
public interface param_3{
public const string label = "Transaction ID";
 public const string description = @"Identifier for a specific transaction.";

}

 public const string description = @"Request to start or end a parameter transaction. Multiple kinds of transport layers can be used to exchange
parameters in the transaction (param, param_ext and mavftp). The command response can either be a success/failure
or an in progress in case the receiving side takes some time to apply the parameters.";

}
interface MAV_CMD_SET_FENCE_BREACH_ACTION{
public interface param_1{
public const string label = "Action";
public const string Enum = "FENCE_ACTION";
 public const string description = @"Fence action on breach.";

}

 public const string description = @"Note: Every geofence in a plan can have its own action; if no fence action is defined for a particular
fence the system-default will be used.
          Note: The flight stack should reject a plan or command
that uses a geofence action that it does not support and send a STATUSTEXT with the reason.";

}
interface MAV_CMD_DO_UPGRADE{
public interface param_1{
public const string label = "Component ID";
public const string Enum = "MAV_COMPONENT";
 public const string description = @"Component id of the component to be upgraded. If set to 0, all components should be upgraded.";
...
public const string minValue = "0";
public const string maxValue = "1";
 public const string description = @"0: Do not reboot component after the action is executed, 1: Reboot component after the action is executed.";
...
public interface param_7{
 public const string description = @"WIP: upgrade progress report rate (can be used for more granular control).";

}

 public const string description = @"The system doing the upgrade will report progress using the normal command protocol sequence for a long
running operation.
          Command protocol information: https://mavlink.io/en/services/command.html.";

}
interface MAV_CMD_GROUP_START{
public interface param_1{
public const string label = "Group ID";
public const string increment = "1";
public const string minValue = "0";
public const string maxValue = "16777216";
 public const string description = @"Mission-unique group id.
          Group id is limited because only 24 bit integer can be stored in 32
bit float.";

}

 public const string description = @"Group ids are expected, but not required, to iterate sequentially.
          Groups can be nested.";

}
interface MAV_CMD_GROUP_END{
public interface param_1{
public const string label = "Group ID";
public const string increment = "1";
public const string minValue = "0";
...
interface MAV_CMD_DO_SET_STANDARD_MODE{
public interface param_1{
...
public const string Default = "NaN";
 ...
 public const string description = @"Enable the specified standard MAVLink mode.
          If the mode is not supported the vehicle should
ACK with MAV_RESULT_FAILED.";

}
interface MAV_CMD_STORM32_DO_GIMBAL_MANAGER_CONTROL_PITCHYAW{
public interface param_1{
public const string label = "Pitch angle";
public const string minValue = "-180";
public const string maxValue = "180";
...
public const string minValue = "-180";
public const string maxValue = "180";
 public const string description = @"Yaw/pan angle (positive: pan to the right, the frame is determined by the STORM32_GIMBAL_DEVICE_FLAGS_YAW_ABSOLUTE
flag, NaN to be ignored).";
...
public interface param_4{
public const string label = "Yaw rate";
 public const string description = @"Yaw/pan rate (positive: pan to the right, the frame is determined by the STORM32_GIMBAL_DEVICE_FLAGS_YAW_ABSOLUTE
flag, NaN to be ignored).";

}
public interface param_5{
public const string label = "Gimbal device flags";
public const string Enum = "MAV_STORM32_GIMBAL_DEVICE_FLAGS";
 public const string description = @"Gimbal device flags.";

}
public interface param_6{
public const string label = "Gimbal manager flags";
public const string Enum = "MAV_STORM32_GIMBAL_MANAGER_FLAGS";
 public const string description = @"Gimbal manager flags.";

}
public interface param_7{
public const string label = "Gimbal ID and client ID";
...
interface MAV_CMD_STORM32_DO_GIMBAL_MANAGER_SETUP{
public interface param_1{
...
public interface param_2{
public const string label = "Setup flags";
public const string Enum = "MAV_STORM32_GIMBAL_MANAGER_SETUP_FLAGS";
 public const string description = @"Gimbal manager setup flags (0 = none).";
...
interface MAV_CMD_STORM32_DO_GIMBAL_ACTION{
public interface param_1{
public const string label = "Action";
public const string Enum = "MAV_STORM32_GIMBAL_ACTION";
 public const string description = @"Gimbal action to initiate (0 = none).";

}
public interface param_7{
public const string label = "Gimbal ID";
 public const string description = @"Gimbal ID of the gimbal to address (component ID or 1-6 for non-MAVLink gimbal, 0 for all gimbals). Send
command multiple times for more than one but not all gimbals.";

}

 public const string description = @"Command to initiate gimbal actions. Usually performed by the gimbal device, but some can also be done
by the gimbal manager. It is hence best to broadcast this command.";

}
interface MAV_CMD_QSHOT_DO_CONFIGURE{
public interface param_1{
public const string label = "Mode";
...
interface MAV_CMD_PRS_GET_BATTERY{
public interface param_1{
 public const string description = @"User defined";
...
interface MAV_CMD_PRS_SET_ARM_ALTI{
public interface param_1{
public const string label = "Altitude";
...
interface MAV_CMD_PRS_GET_ARM_ALTI{
public interface param_1{
 public const string description = @"User defined";
...
interface MAV_CMD_PRS_SHUTDOWN{
public interface param_1{
 public const string description = @"User defined";
