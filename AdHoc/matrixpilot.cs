...
*/
interface FLEXIFUNCTION_READ_REQ{
...
*/
interface FLEXIFUNCTION_BUFFER_FUNCTION{
...
Flexifunction type and parameters for component at function index from buffer
*/
interface FLEXIFUNCTION_BUFFER_FUNCTION_ACK{
...
*/
interface FLEXIFUNCTION_DIRECTORY{
...
Acknowldge sucess or failure of a flexifunction command
*/
interface FLEXIFUNCTION_DIRECTORY_ACK{
...
Acknowldge sucess or failure of a flexifunction command
*/
interface FLEXIFUNCTION_COMMAND{
...
Acknowldge sucess or failure of a flexifunction command
*/
interface FLEXIFUNCTION_COMMAND_ACK{
...
*/
interface SERIAL_UDB_EXTRA_F2_A{
...
*/
interface SERIAL_UDB_EXTRA_F2_B{
...
*/
 short  sue_bat_amp_hours();

/**
Sue autopilot desired height
*/
 short  sue_desired_height();

/**
Serial UDB Extra Stack Memory Free
*/
 short  sue_memory_stack_free();
...
*/
interface SERIAL_UDB_EXTRA_F13{
...
*/
interface SERIAL_UDB_EXTRA_F14{

/**
Serial UDB Extra Wind Estimation Enabled
*/
 byte  sue_WIND_ESTIMATION();
...
*/
interface SERIAL_UDB_EXTRA_F15{

/**
Serial UDB Extra Model Name Of Vehicle
*/
[Dims( +40 )]  byte  sue_ID_VEHICLE_MODEL_NAME();

/**
Serial UDB Extra Registraton Number of Vehicle
*/
[Dims( +20 )]  byte  sue_ID_VEHICLE_REGISTRATION();
...
*/
interface SERIAL_UDB_EXTRA_F16{

/**
Serial UDB Extra Name of Expected Lead Pilot
*/
[Dims( +40 )]  byte  sue_ID_LEAD_PILOT();

/**
Serial UDB Extra URL of Lead Pilot or Team
*/
[Dims( +70 )]  byte  sue_ID_DIY_DRONES_URL();
...
*/
interface SERIAL_UDB_EXTRA_F17{

/**
SUE Feed Forward Gain
*/
 float  sue_feed_forward();

/**
SUE Max Turn Rate when Navigating
*/
 float  sue_turn_rate_nav();
...
*/
interface SERIAL_UDB_EXTRA_F18{
...
*/
 float  elevator_trim_normal();

/**
SUE Elevator Trim Inverted
*/
 float  elevator_trim_inverted();
...
*/
interface SERIAL_UDB_EXTRA_F19{

/**
SUE aileron output channel
*/
 byte  sue_aileron_output_channel();

/**
SUE aileron reversed
*/
 byte  sue_aileron_reversed();

/**
SUE elevator output channel
*/
 byte  sue_elevator_output_channel();

/**
SUE elevator reversed
*/
 byte  sue_elevator_reversed();

/**
SUE throttle output channel
*/
 byte  sue_throttle_output_channel();

/**
SUE throttle reversed
*/
 byte  sue_throttle_reversed();

/**
SUE rudder output channel
*/
 byte  sue_rudder_output_channel();

/**
SUE rudder reversed
*/
 byte  sue_rudder_reversed();
...
*/
interface SERIAL_UDB_EXTRA_F21{

/**
SUE X accelerometer offset
*/
 short  sue_accel_x_offset();

/**
SUE Y accelerometer offset
*/
 short  sue_accel_y_offset();

/**
SUE Z accelerometer offset
*/
 short  sue_accel_z_offset();

/**
SUE X gyro offset
*/
 short  sue_gyro_x_offset();

/**
SUE Y gyro offset
*/
 short  sue_gyro_y_offset();

/**
SUE Z gyro offset
*/
 short  sue_gyro_z_offset();
...
*/
interface SERIAL_UDB_EXTRA_F22{

/**
SUE X accelerometer at calibration time
*/
 short  sue_accel_x_at_calibration();

/**
SUE Y accelerometer at calibration time
*/
 short  sue_accel_y_at_calibration();

/**
SUE Z accelerometer at calibration time
*/
 short  sue_accel_z_at_calibration();

/**
SUE X gyro at calibration time
*/
 short  sue_gyro_x_at_calibration();

/**
SUE Y gyro at calibration time
*/
 short  sue_gyro_y_at_calibration();

/**
SUE Z gyro at calibration time
*/
 short  sue_gyro_z_at_calibration();
...
interface MAV_CMD_PREFLIGHT_STORAGE_ADVANCED{
public interface param_1{
 public const string description = @"Storage action: Action defined by MAV_PREFLIGHT_STORAGE_ACTION_ADVANCED";

}
public interface param_2{
 public const string description = @"Storage area as defined by parameter database";

}
public interface param_3{
 public const string description = @"Storage flags as defined by parameter database";
