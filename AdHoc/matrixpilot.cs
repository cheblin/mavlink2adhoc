...
namespace org.mavlink {
    ...
    /**
        ...
        <see cref = 'AIRSPEEDS' id = '182'/>
        <see cref = 'AIS_VESSEL' id = '301'/>
        <see cref = 'ALTITUDE' id = '141'/>
        <see cref = 'ALTITUDES' id = '181'/>
        ...
        <see cref = 'FLEXIFUNCTION_BUFFER_FUNCTION' id = '152'/>
        <see cref = 'FLEXIFUNCTION_BUFFER_FUNCTION_ACK' id = '153'/>
        <see cref = 'FLEXIFUNCTION_COMMAND' id = '157'/>
        <see cref = 'FLEXIFUNCTION_COMMAND_ACK' id = '158'/>
        <see cref = 'FLEXIFUNCTION_DIRECTORY' id = '155'/>
        <see cref = 'FLEXIFUNCTION_DIRECTORY_ACK' id = '156'/>
        <see cref = 'FLEXIFUNCTION_READ_REQ' id = '151'/>
        <see cref = 'FLEXIFUNCTION_SET' id = '150'/>
        ...
        <see cref = 'SERIAL_UDB_EXTRA_F13' id = '177'/>
        <see cref = 'SERIAL_UDB_EXTRA_F14' id = '178'/>
        <see cref = 'SERIAL_UDB_EXTRA_F15' id = '179'/>
        <see cref = 'SERIAL_UDB_EXTRA_F16' id = '180'/>
        <see cref = 'SERIAL_UDB_EXTRA_F17' id = '183'/>
        <see cref = 'SERIAL_UDB_EXTRA_F18' id = '184'/>
        <see cref = 'SERIAL_UDB_EXTRA_F19' id = '185'/>
        <see cref = 'SERIAL_UDB_EXTRA_F20' id = '186'/>
        <see cref = 'SERIAL_UDB_EXTRA_F21' id = '187'/>
        <see cref = 'SERIAL_UDB_EXTRA_F22' id = '188'/>
        <see cref = 'SERIAL_UDB_EXTRA_F2_A' id = '170'/>
        <see cref = 'SERIAL_UDB_EXTRA_F2_B' id = '171'/>
        <see cref = 'SERIAL_UDB_EXTRA_F4' id = '172'/>
        <see cref = 'SERIAL_UDB_EXTRA_F5' id = '173'/>
        <see cref = 'SERIAL_UDB_EXTRA_F6' id = '174'/>
        <see cref = 'SERIAL_UDB_EXTRA_F7' id = '175'/>
        <see cref = 'SERIAL_UDB_EXTRA_F8' id = '176'/>
...
*/
class FLEXIFUNCTION_BUFFER_FUNCTION{
...
Flexifunction type and parameters for component at function index from buffer
*/
class FLEXIFUNCTION_BUFFER_FUNCTION_ACK{
...
Acknowledge success or failure of a flexifunction command
*/
class FLEXIFUNCTION_DIRECTORY_ACK{
...
Acknowledge success or failure of a flexifunction command
*/
class FLEXIFUNCTION_COMMAND_ACK{
...
*/
class SERIAL_UDB_EXTRA_F15{

/**
Serial UDB Extra Model Name Of Vehicle
*/
[D(40)]  byte [] sue_ID_VEHICLE_MODEL_NAME;

/**
Serial UDB Extra Registraton Number of Vehicle
*/
[D(20)]  byte [] sue_ID_VEHICLE_REGISTRATION;
...
struct MAV_CMD_PREFLIGHT_STORAGE_ADVANCED{
public struct param_1{
