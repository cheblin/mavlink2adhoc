...
namespace org.mavlink{
    /**
        ...
        <see cref = 'SCRIPT_COUNT' id = '183'/>
        <see cref = 'SCRIPT_CURRENT' id = '184'/>
        <see cref = 'SCRIPT_ITEM' id = '180'/>
        <see cref = 'SCRIPT_REQUEST' id = '181'/>
        <see cref = 'SCRIPT_REQUEST_LIST' id = '182'/>
