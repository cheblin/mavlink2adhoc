...
public interface CommonPacks {  @id(87) public static class POSITION_TARGET_GLOBAL_INT{
/**
Timestamp (time since system boot). The rationale for the timestamp in the setpoint is to allow the system
to compensate for the transport delay of the setpoint. This allows the system to compensate processing
latency*/
...
@id(150) public static class AQ_TELEMETRY_F{
@I short  Index;//Index of message
 float  value1;//value1
 float  value2;//value2
 float  value3;//value3
 float  value4;//value4
...
/**
>4 motors. Data is described as follows: 
// unsigned int state : 3;// unsigned int vin :12;// x 100
// unsigned int amps :14;// x 100// unsigned int rpm :15;
// unsigned int duty :8; // x (255/100)// - Data Version 2 -
// unsigned int errors :9; // Bad detects error count// - Data Version 3 -
// unsigned int temp :9; // (Deg C + 32) * 4// unsigned int errCode : 3;
*/
@id(152) public static class AQ_ESC_TELEMETRY{
@I  int  time_boot_ms;//Timestamp of the component clock since boot time in ms.
@I byte  seq;//Sequence number of message (first set of 4 motors is #1, next 4 is #2, etc).
@I byte  num_motors;//Total number of active ESCs/motors on the system.
@I byte  num_in_seq;//Number of active ESCs in this sequence (1 through this many array members will be populated with data
@I @__( 4 )  byte  escid;//ESC/Motor ID
@I @__( 4 )  short  status_age;//Age of each ESC telemetry reading in ms compared to boot time. A value of 0xFFFF means timeout/no data
@I @__( 4 )  byte  data_version;//Version of data structure (determines contents).
@I @__( 4 )   int  data0;//Data bits 1-32 for each ESC.
@I @__( 4 )   int  data1;//Data bits 33-64 for each ESC.
}
}}
/**
...
/**
Track current version of these definitions (can be used by checking value of AUTOQUAD_MAVLINK_DEFS_VERSION_ENUM_END).
Append a new entry for each published change*/
enum AUTOQUAD_MAVLINK_DEFS_VERSION
{ 
...
additional active features/modifiers/constraints.*/
 @Flags enum AUTOQUAD_NAV_STATUS
{ 
;
...
AQ_NAV_STATUS_DAO = 0x02000000, //Dynamic Altitude Override is active (AH with proportional manual adjustment)
