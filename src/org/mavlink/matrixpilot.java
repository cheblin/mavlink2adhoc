...
public interface CommonPacks {  @id(101) public static class GLOBAL_VISION_POSITION_ESTIMATE{
...
@id(150) public static class FLEXIFUNCTION_SET{
@I byte  target_system;//System ID
@I byte  target_component;//Component ID
}
...
@id(151) public static class FLEXIFUNCTION_READ_REQ{
@I byte  target_system;//System ID
@I byte  target_component;//Component ID
 short  read_req_type;//Type of flexifunction data requested
 short  data_index;//index into data where needed
}

/**
Flexifunction type and parameters for component at function index from buffer*/
@id(152) public static class FLEXIFUNCTION_BUFFER_FUNCTION{
@I byte  target_system;//System ID
@I byte  target_component;//Component ID
@I short  func_index;//Function index
@I short  func_count;//Total count of functions
@I short  data_address;//Address in the flexifunction data, Set to 0xFFFF to use address in target memory
@I short  data_size;//Size of the 
 @__( 48 )  byte  data;//Settings data
}

/**
Flexifunction type and parameters for component at function index from buffer*/
@id(153) public static class FLEXIFUNCTION_BUFFER_FUNCTION_ACK{
@I byte  target_system;//System ID
@I byte  target_component;//Component ID
@I short  func_index;//Function index
@I short  result;//result of acknowledge, 0=fail, 1=good
}

/**
Acknowldge sucess or failure of a flexifunction command*/
@id(155) public static class FLEXIFUNCTION_DIRECTORY{
@I byte  target_system;//System ID
@I byte  target_component;//Component ID
@I byte  directory_type;//0=inputs, 1=outputs
@I byte  start_index;//index of first directory entry to write
@I byte  count;//count of directory entries to write
 @__( 48 )  byte  directory_data;//Settings data
}

/**
Acknowldge sucess or failure of a flexifunction command*/
@id(156) public static class FLEXIFUNCTION_DIRECTORY_ACK{
@I byte  target_system;//System ID
@I byte  target_component;//Component ID
@I byte  directory_type;//0=inputs, 1=outputs
@I byte  start_index;//index of first directory entry to write
...
/**
Acknowldge sucess or failure of a flexifunction command*/
@id(157) public static class FLEXIFUNCTION_COMMAND{
@I byte  target_system;//System ID
@I byte  target_component;//Component ID
@I byte  command_type;//Flexifunction command type
}

/**
Acknowldge sucess or failure of a flexifunction command*/
@id(158) public static class FLEXIFUNCTION_COMMAND_ACK{
@I short  command_type;//Command acknowledged
@I short  result;//result of acknowledge
}

/**
Backwards compatible MAVLink version of SERIAL_UDB_EXTRA - F2: Format Part A*/
@id(170) public static class SERIAL_UDB_EXTRA_F2_A{
@I  int  sue_time;//Serial UDB Extra Time
@I byte  sue_status;//Serial UDB Extra Status
  int  sue_latitude;//Serial UDB Extra Latitude
  int  sue_longitude;//Serial UDB Extra Longitude
  int  sue_altitude;//Serial UDB Extra Altitude
@I short  sue_waypoint_index;//Serial UDB Extra Waypoint Index
 short  sue_rmat0;//Serial UDB Extra Rmat 0
 short  sue_rmat1;//Serial UDB Extra Rmat 1
 short  sue_rmat2;//Serial UDB Extra Rmat 2
 short  sue_rmat3;//Serial UDB Extra Rmat 3
 short  sue_rmat4;//Serial UDB Extra Rmat 4
 short  sue_rmat5;//Serial UDB Extra Rmat 5
 short  sue_rmat6;//Serial UDB Extra Rmat 6
 short  sue_rmat7;//Serial UDB Extra Rmat 7
 short  sue_rmat8;//Serial UDB Extra Rmat 8
@I short  sue_cog;//Serial UDB Extra GPS Course Over Ground
 short  sue_sog;//Serial UDB Extra Speed Over Ground
@I short  sue_cpu_load;//Serial UDB Extra CPU Load
@I short  sue_air_speed_3DIMU;//Serial UDB Extra 3D IMU Air Speed
 short  sue_estimated_wind_0;//Serial UDB Extra Estimated Wind 0
 short  sue_estimated_wind_1;//Serial UDB Extra Estimated Wind 1
 short  sue_estimated_wind_2;//Serial UDB Extra Estimated Wind 2
 short  sue_magFieldEarth0;//Serial UDB Extra Magnetic Field Earth 0 
 short  sue_magFieldEarth1;//Serial UDB Extra Magnetic Field Earth 1 
 short  sue_magFieldEarth2;//Serial UDB Extra Magnetic Field Earth 2 
 short  sue_svs;//Serial UDB Extra Number of Sattelites in View
 short  sue_hdop;//Serial UDB Extra GPS Horizontal Dilution of Precision
}

/**
Backwards compatible version of SERIAL_UDB_EXTRA - F2: Part B*/
@id(171) public static class SERIAL_UDB_EXTRA_F2_B{
@I  int  sue_time;//Serial UDB Extra Time
 short  sue_pwm_input_1;//Serial UDB Extra PWM Input Channel 1
 short  sue_pwm_input_2;//Serial UDB Extra PWM Input Channel 2
 short  sue_pwm_input_3;//Serial UDB Extra PWM Input Channel 3
 short  sue_pwm_input_4;//Serial UDB Extra PWM Input Channel 4
 short  sue_pwm_input_5;//Serial UDB Extra PWM Input Channel 5
 short  sue_pwm_input_6;//Serial UDB Extra PWM Input Channel 6
 short  sue_pwm_input_7;//Serial UDB Extra PWM Input Channel 7
 short  sue_pwm_input_8;//Serial UDB Extra PWM Input Channel 8
 short  sue_pwm_input_9;//Serial UDB Extra PWM Input Channel 9
 short  sue_pwm_input_10;//Serial UDB Extra PWM Input Channel 10
 short  sue_pwm_input_11;//Serial UDB Extra PWM Input Channel 11
 short  sue_pwm_input_12;//Serial UDB Extra PWM Input Channel 12
 short  sue_pwm_output_1;//Serial UDB Extra PWM Output Channel 1
 short  sue_pwm_output_2;//Serial UDB Extra PWM Output Channel 2
 short  sue_pwm_output_3;//Serial UDB Extra PWM Output Channel 3
 short  sue_pwm_output_4;//Serial UDB Extra PWM Output Channel 4
 short  sue_pwm_output_5;//Serial UDB Extra PWM Output Channel 5
 short  sue_pwm_output_6;//Serial UDB Extra PWM Output Channel 6
 short  sue_pwm_output_7;//Serial UDB Extra PWM Output Channel 7
 short  sue_pwm_output_8;//Serial UDB Extra PWM Output Channel 8
 short  sue_pwm_output_9;//Serial UDB Extra PWM Output Channel 9
 short  sue_pwm_output_10;//Serial UDB Extra PWM Output Channel 10
 short  sue_pwm_output_11;//Serial UDB Extra PWM Output Channel 11
 short  sue_pwm_output_12;//Serial UDB Extra PWM Output Channel 12
 short  sue_imu_location_x;//Serial UDB Extra IMU Location X
 short  sue_imu_location_y;//Serial UDB Extra IMU Location Y
 short  sue_imu_location_z;//Serial UDB Extra IMU Location Z
 short  sue_location_error_earth_x;//Serial UDB Location Error Earth X
 short  sue_location_error_earth_y;//Serial UDB Location Error Earth Y
 short  sue_location_error_earth_z;//Serial UDB Location Error Earth Z
@I  int  sue_flags;//Serial UDB Extra Status Flags
 short  sue_osc_fails;//Serial UDB Extra Oscillator Failure Count
 short  sue_imu_velocity_x;//Serial UDB Extra IMU Velocity X
 short  sue_imu_velocity_y;//Serial UDB Extra IMU Velocity Y
 short  sue_imu_velocity_z;//Serial UDB Extra IMU Velocity Z
 short  sue_waypoint_goal_x;//Serial UDB Extra Current Waypoint Goal X
 short  sue_waypoint_goal_y;//Serial UDB Extra Current Waypoint Goal Y
 short  sue_waypoint_goal_z;//Serial UDB Extra Current Waypoint Goal Z
 short  sue_aero_x;//Aeroforce in UDB X Axis
 short  sue_aero_y;//Aeroforce in UDB Y Axis
 short  sue_aero_z;//Aeroforce in UDB Z axis
 short  sue_barom_temp;//SUE barometer temperature
  int  sue_barom_press;//SUE barometer pressure
  int  sue_barom_alt;//SUE barometer altitude
 short  sue_bat_volt;//SUE battery voltage
 short  sue_bat_amp;//SUE battery current
 short  sue_bat_amp_hours;//SUE battery milli amp hours used
 short  sue_desired_height;//Sue autopilot desired height
 short  sue_memory_stack_free;//Serial UDB Extra Stack Memory Free
}

/**
Backwards compatible version of SERIAL_UDB_EXTRA F4: format*/
@id(172) public static class SERIAL_UDB_EXTRA_F4{
@I byte  sue_ROLL_STABILIZATION_AILERONS;//Serial UDB Extra Roll Stabilization with Ailerons Enabled
@I byte  sue_ROLL_STABILIZATION_RUDDER;//Serial UDB Extra Roll Stabilization with Rudder Enabled
@I byte  sue_PITCH_STABILIZATION;//Serial UDB Extra Pitch Stabilization Enabled
@I byte  sue_YAW_STABILIZATION_RUDDER;//Serial UDB Extra Yaw Stabilization using Rudder Enabled
@I byte  sue_YAW_STABILIZATION_AILERON;//Serial UDB Extra Yaw Stabilization using Ailerons Enabled
@I byte  sue_AILERON_NAVIGATION;//Serial UDB Extra Navigation with Ailerons Enabled
@I byte  sue_RUDDER_NAVIGATION;//Serial UDB Extra Navigation with Rudder Enabled
@I byte  sue_ALTITUDEHOLD_STABILIZED;//Serial UDB Extra Type of Alitude Hold when in Stabilized Mode
@I byte  sue_ALTITUDEHOLD_WAYPOINT;//Serial UDB Extra Type of Alitude Hold when in Waypoint Mode
@I byte  sue_RACING_MODE;//Serial UDB Extra Firmware racing mode enabled
}

/**
Backwards compatible version of SERIAL_UDB_EXTRA F5: format*/
@id(173) public static class SERIAL_UDB_EXTRA_F5{
...
@id(174) public static class SERIAL_UDB_EXTRA_F6{
...
@id(175) public static class SERIAL_UDB_EXTRA_F7{
...
@id(176) public static class SERIAL_UDB_EXTRA_F8{
...
@id(177) public static class SERIAL_UDB_EXTRA_F13{
 short  sue_week_no;//Serial UDB Extra GPS Week Number
  int  sue_lat_origin;//Serial UDB Extra MP Origin Latitude
  int  sue_lon_origin;//Serial UDB Extra MP Origin Longitude
  int  sue_alt_origin;//Serial UDB Extra MP Origin Altitude Above Sea Level
}

/**
Backwards compatible version of SERIAL_UDB_EXTRA F14: format*/
@id(178) public static class SERIAL_UDB_EXTRA_F14{
@I byte  sue_WIND_ESTIMATION;//Serial UDB Extra Wind Estimation Enabled
@I byte  sue_GPS_TYPE;//Serial UDB Extra Type of GPS Unit
@I byte  sue_DR;//Serial UDB Extra Dead Reckoning Enabled
@I byte  sue_BOARD_TYPE;//Serial UDB Extra Type of UDB Hardware
@I byte  sue_AIRFRAME;//Serial UDB Extra Type of Airframe
 short  sue_RCON;//Serial UDB Extra Reboot Register of DSPIC
 short  sue_TRAP_FLAGS;//Serial UDB Extra  Last dspic Trap Flags
@I  int  sue_TRAP_SOURCE;//Serial UDB Extra Type Program Address of Last Trap
 short  sue_osc_fail_count;//Serial UDB Extra Number of Ocillator Failures
@I byte  sue_CLOCK_CONFIG;//Serial UDB Extra UDB Internal Clock Configuration
@I byte  sue_FLIGHT_PLAN_TYPE;//Serial UDB Extra Type of Flight Plan
}

/**
Backwards compatible version of SERIAL_UDB_EXTRA F15 format*/
@id(179) public static class SERIAL_UDB_EXTRA_F15{
@I @__( 40 )  byte  sue_ID_VEHICLE_MODEL_NAME;//Serial UDB Extra Model Name Of Vehicle
@I @__( 20 )  byte  sue_ID_VEHICLE_REGISTRATION;//Serial UDB Extra Registraton Number of Vehicle
}

/**
Backwards compatible version of SERIAL_UDB_EXTRA F16 format*/
@id(180) public static class SERIAL_UDB_EXTRA_F16{
@I @__( 40 )  byte  sue_ID_LEAD_PILOT;//Serial UDB Extra Name of Expected Lead Pilot
@I @__( 70 )  byte  sue_ID_DIY_DRONES_URL;//Serial UDB Extra URL of Lead Pilot or Team
}

/**
The altitude measured by sensors and IMU*/
@id(181) public static class ALTITUDES{
@I  int  time_boot_ms;//Timestamp (milliseconds since system boot)
  int  alt_gps;//GPS altitude (MSL) in meters, expressed as * 1000 (millimeters)
  int  alt_imu;//IMU altitude above ground in meters, expressed as * 1000 (millimeters)
  int  alt_barometric;//barometeric altitude above ground in meters, expressed as * 1000 (millimeters)
  int  alt_optical_flow;//Optical flow altitude above ground in meters, expressed as * 1000 (millimeters)
  int  alt_range_finder;//Rangefinder Altitude above ground in meters, expressed as * 1000 (millimeters)
  int  alt_extra;//Extra altitude above ground in meters, expressed as * 1000 (millimeters)
}

/**
The airspeed measured by sensors and IMU*/
@id(182) public static class AIRSPEEDS{
@I  int  time_boot_ms;//Timestamp (milliseconds since system boot)
 short  airspeed_imu;//Airspeed estimate from IMU, cm/s
 short  airspeed_pitot;//Pitot measured forward airpseed, cm/s
 short  airspeed_hot_wire;//Hot wire anenometer measured airspeed, cm/s
 short  airspeed_ultrasonic;//Ultrasonic measured airspeed, cm/s
 short  aoa;//Angle of attack sensor, degrees * 10
 short  aoy;//Yaw angle sensor, degrees * 10
}

/**
Backwards compatible version of SERIAL_UDB_EXTRA F17 format*/
@id(183) public static class SERIAL_UDB_EXTRA_F17{
...
@id(184) public static class SERIAL_UDB_EXTRA_F18{
...
@id(185) public static class SERIAL_UDB_EXTRA_F19{
@I byte  sue_aileron_output_channel;//SUE aileron output channel
@I byte  sue_aileron_reversed;//SUE aileron reversed
@I byte  sue_elevator_output_channel;//SUE elevator output channel
@I byte  sue_elevator_reversed;//SUE elevator reversed
@I byte  sue_throttle_output_channel;//SUE throttle output channel
@I byte  sue_throttle_reversed;//SUE throttle reversed
@I byte  sue_rudder_output_channel;//SUE rudder output channel
@I byte  sue_rudder_reversed;//SUE rudder reversed
}

/**
Backwards compatible version of SERIAL_UDB_EXTRA F20 format*/
@id(186) public static class SERIAL_UDB_EXTRA_F20{
@I byte  sue_number_of_inputs;//SUE Number of Input Channels
 short  sue_trim_value_input_1;//SUE UDB PWM Trim Value on Input 1
 short  sue_trim_value_input_2;//SUE UDB PWM Trim Value on Input 2
 short  sue_trim_value_input_3;//SUE UDB PWM Trim Value on Input 3
 short  sue_trim_value_input_4;//SUE UDB PWM Trim Value on Input 4
 short  sue_trim_value_input_5;//SUE UDB PWM Trim Value on Input 5
 short  sue_trim_value_input_6;//SUE UDB PWM Trim Value on Input 6
 short  sue_trim_value_input_7;//SUE UDB PWM Trim Value on Input 7
 short  sue_trim_value_input_8;//SUE UDB PWM Trim Value on Input 8
 short  sue_trim_value_input_9;//SUE UDB PWM Trim Value on Input 9
 short  sue_trim_value_input_10;//SUE UDB PWM Trim Value on Input 10
 short  sue_trim_value_input_11;//SUE UDB PWM Trim Value on Input 11
 short  sue_trim_value_input_12;//SUE UDB PWM Trim Value on Input 12
}

/**
Backwards compatible version of SERIAL_UDB_EXTRA F21 format*/
@id(187) public static class SERIAL_UDB_EXTRA_F21{
 short  sue_accel_x_offset;//SUE X accelerometer offset
 short  sue_accel_y_offset;//SUE Y accelerometer offset
 short  sue_accel_z_offset;//SUE Z accelerometer offset
 short  sue_gyro_x_offset;//SUE X gyro offset
 short  sue_gyro_y_offset;//SUE Y gyro offset
 short  sue_gyro_z_offset;//SUE Z gyro offset
}

/**
Backwards compatible version of SERIAL_UDB_EXTRA F22 format*/
@id(188) public static class SERIAL_UDB_EXTRA_F22{
 short  sue_accel_x_at_calibration;//SUE X accelerometer at calibration time
 short  sue_accel_y_at_calibration;//SUE Y accelerometer at calibration time
 short  sue_accel_z_at_calibration;//SUE Z accelerometer at calibration time
 short  sue_gyro_x_at_calibration;//SUE X gyro at calibration time
 short  sue_gyro_y_at_calibration;//SUE Y gyro at calibration time
 short  sue_gyro_z_at_calibration;//SUE Z gyro at calibration time
}
}}
/**
