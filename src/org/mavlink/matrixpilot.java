...
public interface matrixpilot {
	class CommunicationChannel extends AdvProtocol implements GroundControl.CommunicationInterface, MicroAirVehicle.CommunicationInterface {}
	...
	class MicroAirVehicle implements InC, InCPP {
		...
		public interface MicroAirVehicleHandledPacks {
			 ...
			 */
			@id(150) class FLEXIFUNCTION_SET {
				@I byte target_system;//System ID
				@I byte target_component;//Component ID
			}
			 ...
			 */
			@id(151) class FLEXIFUNCTION_READ_REQ {
				@I byte target_system;//System ID
				@I byte target_component;//Component ID
			 ...
			 */
			@id(152) class FLEXIFUNCTION_BUFFER_FUNCTION {
				@I      byte  target_system;//System ID
				@I      byte  target_component;//Component ID
			...
			/**
			 Flexifunction type and parameters for component at function index from buffer
			 */
			@id(153) class FLEXIFUNCTION_BUFFER_FUNCTION_ACK {
				@I byte  target_system;//System ID
				@I byte  target_component;//Component ID
				@I short func_index;//Function index
			 ...
			 */
			@id(155) class FLEXIFUNCTION_DIRECTORY {
				@I      byte target_system;//System ID
				@I      byte target_component;//Component ID
			...
			/**
			 Acknowldge sucess or failure of a flexifunction command
			 */
			@id(156) class FLEXIFUNCTION_DIRECTORY_ACK {
				@I byte  target_system;//System ID
				@I byte  target_component;//Component ID
				@I byte  directory_type;//0=inputs, 1=outputs
				@I byte  start_index;//index of first directory entry to write
			...
			/**
			 Acknowldge sucess or failure of a flexifunction command
			 */
			@id(157) class FLEXIFUNCTION_COMMAND {
				@I byte target_system;//System ID
				@I byte target_component;//Component ID
			...
			/**
			 Acknowldge sucess or failure of a flexifunction command
			 */
			@id(158) class FLEXIFUNCTION_COMMAND_ACK {
			 ...
			 */
			@id(170) class SERIAL_UDB_EXTRA_F2_A {
			 ...
			 */
			@id(171) class SERIAL_UDB_EXTRA_F2_B {
				@I int sue_time;//Serial UDB Extra Time
			 ...
			 */
			@id(172) class SERIAL_UDB_EXTRA_F4 {
			 ...
			 */
			@id(173) class SERIAL_UDB_EXTRA_F5 {
			 ...
			 */
			@id(174) class SERIAL_UDB_EXTRA_F6 {
			 ...
			 */
			@id(175) class SERIAL_UDB_EXTRA_F7 {
			 ...
			 */
			@id(176) class SERIAL_UDB_EXTRA_F8 {
			 ...
			 */
			@id(177) class SERIAL_UDB_EXTRA_F13 {
			 ...
			 */
			@id(178) class SERIAL_UDB_EXTRA_F14 {
			 ...
			 */
			@id(179) class SERIAL_UDB_EXTRA_F15 {
			 ...
			 */
			@id(180) class SERIAL_UDB_EXTRA_F16 {
			 ...
			 */
			@id(183) class SERIAL_UDB_EXTRA_F17 {
			 ...
			 */
			@id(184) class SERIAL_UDB_EXTRA_F18 {
			 ...
			 */
			@id(185) class SERIAL_UDB_EXTRA_F19 {
			 ...
			 */
			@id(186) class SERIAL_UDB_EXTRA_F20 {
			 ...
			 */
			@id(187) class SERIAL_UDB_EXTRA_F21 {
			 ...
			 */
			@id(188) class SERIAL_UDB_EXTRA_F22 {
