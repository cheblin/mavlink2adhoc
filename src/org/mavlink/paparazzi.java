...
public interface CommonPacks {  @id(89) public static class LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET{
@I  int  time_boot_ms;//Timestamp (time since system boot).
 float  x;//X Position
 float  y;//Y Position
 float  z;//Z Position
...
@id(180) public static class SCRIPT_ITEM{
@I byte  target_system;//System ID
@I byte  target_component;//Component ID
@I short  seq;//Sequence
@__(50) String  name;//The name of the mission script, NULL terminated.
}
...
@id(181) public static class SCRIPT_REQUEST{
@I byte  target_system;//System ID
@I byte  target_component;//Component ID
@I short  seq;//Sequence
}
...
/**
Request the overall list of mission items from the system/component.*/
@id(182) public static class SCRIPT_REQUEST_LIST{
@I byte  target_system;//System ID
@I byte  target_component;//Component ID
}
...
@id(183) public static class SCRIPT_COUNT{
@I byte  target_system;//System ID
@I byte  target_component;//Component ID
@I short  count;//Number of script items in the sequence
}

/**
This message informs about the currently active SCRIPT.*/
@id(184) public static class SCRIPT_CURRENT{
@I short  seq;//Active Sequence
}
}}
/**
