...
public interface slugs {
	...
	class MicroAirVehicle implements InC, InCPP {
		...
		public interface MicroAirVehicleHandledPacks {
			 ...
			 */
			@id(184) class SLUGS_CAMERA_ORDER {
			 ...
			 */
			@id(186) class SLUGS_MOBILE_LOCATION {
				@I byte target;//The system reporting the action
			...
			/**
			 Control for camara.
			 */
			@id(188) class SLUGS_CONFIGURATION_CAMERA {
				@I byte target;//The system setting the commands
