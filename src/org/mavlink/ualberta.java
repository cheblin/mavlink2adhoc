...
public interface CommonPacks {  @id(86) public static class SET_POSITION_TARGET_GLOBAL_INT{
/**
...
@id(220) public static class NAV_FILTER_BIAS{
@I long  usec;//Timestamp (microseconds)
 float  accel_0;//b_f[0]
 float  accel_1;//b_f[1]
 float  accel_2;//b_f[2]
 float  gyro_0;//b_f[0]
...
@id(221) public static class RADIO_CALIBRATION{
@I @__( 3 )  short  aileron;//Aileron setpoints: left, center, right
@I @__( 3 )  short  elevator;//Elevator setpoints: nose down, center, nose up
@I @__( 3 )  short  rudder;//Rudder setpoints: nose left, center, nose right
@I @__( 2 )  short  gyro;//Tail gyro mode/gain setpoints: heading hold, rate mode
@I @__( 5 )  short  pitch;//Pitch curve setpoints (every 25%)
@I @__( 5 )  short  throttle;//Throttle curve setpoints (every 25%)
}

/**
System status specific to ualberta uav*/
@id(222) public static class UALBERTA_SYS_STATUS{
@I byte  mode;//System mode, see UALBERTA_AUTOPILOT_MODE ENUM
@I byte  nav_mode;//Navigation mode, see UALBERTA_NAV_MODE ENUM
@I byte  pilot;//Pilot mode, see UALBERTA_PILOT_MODE
}
}}
/**
